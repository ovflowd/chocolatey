...
<head>
    ...
    <head>
        ...
        <title><?php echo e($azure['name']); ?></title>
        ...
        <meta property="og:site_name" content="<?php echo e($azure['name']); ?>">
        <meta property="og:title" content="<?php echo e($azure['name']); ?>">
        <meta property="og:description"
              content="Join millions in the planet&apos;s most popular virtual world for teens. Create your avatar, meet new friends, role play, and build amazing spaces.">
        <meta property="og:image:height" content="628">
        <meta property="og:image:width" content="1200">
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="<?php echo e($azure['name']); ?>">
        <meta name="twitter:description"
              content="Join millions in the planet&apos;s most popular virtual world for teens. Create your avatar, meet new friends, role play, and build amazing spaces.">
        <meta name="twitter:site" content="<?php echo e($azure['twitter']['name']); ?>">
        ...
        <link rel="shortcut icon" href="<?php echo e($azure['url']); ?>habbo-web/favicon.ico">
        <link rel="stylesheet" href="<?php echo e($azure['url']); ?>habbo-web/app.css">
        <script>
            !function () {
...
<script src="<?php echo e($azure['url']); ?>habbo-web/vendor.js"></script>
<script src="<?php echo e($azure['url']); ?>habbo-web/scripts.js"></script>
</body>
</html>