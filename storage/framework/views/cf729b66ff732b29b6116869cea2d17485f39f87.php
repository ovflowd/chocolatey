...
<head>
    ...
    <head>
        ...
        <title><?php echo e($chocolatey['name']); ?></title>
        ...
        <meta property="og:site_name" content="<?php echo e($chocolatey['name']); ?>">
        <meta property="og:title" content="<?php echo e($chocolatey['name']); ?>">
        <meta property="og:description"
              content="Join millions in the planet&apos;s most popular virtual world for teens. Create your avatar, meet new friends, role play, and build amazing spaces.">
        <meta property="og:image:height" content="628">
        <meta property="og:image:width" content="1200">
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="<?php echo e($chocolatey['name']); ?>">
        <meta name="twitter:description"
              content="Join millions in the planet&apos;s most popular virtual world for teens. Create your avatar, meet new friends, role play, and build amazing spaces.">
        <meta name="twitter:site" content="<?php echo e($chocolatey['twitter']['name']); ?>">
        ...
        <link rel="shortcut icon" href="<?php echo e($chocolatey['url']); ?>habbo-web/favicon.ico">
        <link rel="stylesheet" href="<?php echo e($chocolatey['url']); ?>habbo-web/app.css">
        <script>
            !function () {
        ...
        <script>
            ...
            window.banner = null;
            window.chocolatey = {
                captcha: '<?php echo e($chocolatey['recaptcha']); ?>',
                facebook: '<?php echo e($chocolatey['facebook']['app']['key']); ?>',
                url: '<?php echo e($chocolatey['url']); ?>',
                base: '<?php echo e($chocolatey['path']); ?>',
                earn: '<?php echo e($chocolatey['earn'] == 1 ? 'true' : 'false'); ?>',
                name: '<?php echo e($chocolatey['name']); ?>',
                lang: '<?php echo e($chocolatey['language']); ?>'};
        </script>
    </head>
...
<script src="<?php echo e($chocolatey['url']); ?>habbo-web/vendor.js"></script>
<script src="<?php echo e($chocolatey['url']); ?>habbo-web/scripts.js"></script>
</body>
</html>