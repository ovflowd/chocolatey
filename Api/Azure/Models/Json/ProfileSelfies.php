 ...
 */
class ProfileSelfies extends JsonType
{
	 ...
	 * @var string
	 */
	public $title = null, $parentSlug = 'selfie', $parentTitle = 'CHANNEL_SLIDE_HABBO_STORIES_SELFIE_TITLE', $parentType = 'selfie', $tags, $previewUrl, $url, $creator_uniqueId, $creator_id, $creator_name, $time, $type, $id, $likes = [], $version = 1;
