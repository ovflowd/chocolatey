...
<body>
<div class="center">
    <img src="{{$chocolatey->url}}/habbo-web/assets/images/credits_teaser_error.png"
         srcset="{{$chocolatey->url}}/habbo-web/assets/images/credits_teaser_error.png 1x,{{$chocolatey->url}}/habbo-web/assets/images/credits_teaser_error_big.png 2x"
         alt="Error"
         width="145"
         height="146">
