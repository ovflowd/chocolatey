...
<div class="center">
    <img src="{{$chocolatey->hotelUrl}}/habbo-web/assets/images/credits_teaser_success.png" srcset="{{$chocolatey->hotelUrl}}/habbo-web/assets/images/credits_teaser_success.png 1x, {{$chocolatey->hotelUrl}}/habbo-web/assets/images/credits_teaser_success_big.png 2x" alt="Success" width="145" height="146">
