<p>There are many ways to purchase credits on {{$chocolatey['name']}}!</p>
...
<p>If you have a gift card from Subway, CVS/pharmacy, Burger King, Dollar General, Shell, Circle K or oBucks, you can
    use it to buy everything available on the <a href="/shop">Buy page</a> - not only credits, but {{$chocolatey['name']}} Club, Builders
