...
<p><img src="{{$chocolatey->hotelUrl}}habbo-web/assets/web-images/habbo_friends.png" alt="Fansites" class="align-right">
</p>
...
<ul>
    ...
    <li><a href="http://www.{{$chocolatey->hotelName}}x.com" target="_blank">http://www.{{$chocolatey->hotelName}}
            x.com</a></li>
    ...
    <li><a href="http://www.This{{$chocolatey->hotelName}}.com"
           target="_blank">http://www.This{{$chocolatey->hotelName}}.com</a></li>
...
<p>Always remember to keep your {{$chocolatey->hotelName}} login details separate and private! Don&apos;t use them to
    register
    on any other
    sites.</p>