...
<ul>
    ...
    <li><a href="http://www.{{$chocolatey['name']}}x.com" target="_blank">http://www.{{$chocolatey['name']}}x.com</a></li>
    ...
    <li><a href="http://www.This{{$chocolatey['name']}}.com" target="_blank">http://www.This{{$chocolatey['name']}}.com</a></li>
...
<p>Every once in a while, we look for new official fansites, and when that happens we will publish a notification
    ingame. Check out our <a target="_blank"
                             ng-href="@{{'https://help.habbo.com/entries/22405102-{{$chocolatey['name']}}-Fansite-Policy' | zendeskRedirectUrl}}">fansite
