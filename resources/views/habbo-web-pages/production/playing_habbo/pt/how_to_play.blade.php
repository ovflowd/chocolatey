...
<p>Visite a se&#xE7;&#xE3;o <a href="/">In&#xED;cio</a> do {{$chocolatey['name']}} Hotel para saber tudo sobre as &#xFA;ltimas not&#xED;cias,
    competi&#xE7;&#xF5;es e o que est&#xE1; rolando pelo Hotel.</p>
<p>Depois de fazer tudo isso, voc&#xEA; j&#xE1; poder&#xE1; se considerar um cidad&#xE3;o {{$chocolatey['name']}} de primeira
    categoria!</p>
<blockquote>
    <h3>Entre agora!</h3>
    <p>N&#xE3;o se registrou ainda no {{$chocolatey['name']}} Hotel? <a href="/registration">Entre Agora</a>!</p>
</blockquote>
