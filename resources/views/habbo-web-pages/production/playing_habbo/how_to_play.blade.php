...
<h3>Explore rooms</h3>
<p>Click the Navigator and choose one of the public rooms where you can chat with other {{$chocolatey->hotelName}}s.</p>
<hr>
<p>
    <img src="{{$chocolatey->hotelUrl}}habbo-web/assets/web-images/askfriend.png" alt="Ask to be friend" class="align-right">
</p>
<h3>Make friends</h3>
<p>Click on a {{$chocolatey->hotelName}} , ask them to be your friend or give them respect!</p>
<hr>
<p>
...
<h3>Complete your {{$chocolatey->hotelName}} Citizenship</h3>
...
<p>Visit the <a href="/">Home</a> section of the website to find out all the latest news, competitions and general goings-on in {{$chocolatey->hotelName}}</p>
<p>Once you&apos;ve done a few of these, you will be well on your way to becoming a fully fledged {{$chocolatey->hotelName}} citizen!</p>
<blockquote>
    <h3>Join {{$chocolatey->hotelName}} </h3>
    <p>Haven&apos;t registered for {{$chocolatey->hotelName}} yet? <a href="/registration">Join now</a>!</p>
</blockquote>