...
<p>You may occasionally come across the odd misbehaving {{$chocolatey['name']}} . Never fear, help is at hand! On this
    page
    we&apos;ll tell
...
<ol>
    ...
    <li>You won&apos;t see what the {{$chocolatey['name']}} says anymore. If you want to un-ignore later, click the
        avatar
        again and
        choose <em>Listen</em>.
    </li>
...
<ol>
    ...
    <li>Choose <em>Someone is misbehaving</em>. You&apos;ll see a list of all {{$chocolatey['name']}} s in the room.
    </li>
...
<ol>
    <li>Click the <em>Report</em> button below the other {{$chocolatey['name']}} &apos;s picture in the chat window.
    </li>
...
<p>Haven&apos;t read <a href="/playing-habbo/habbo-way">The {{$chocolatey['name']}} Way</a> yet? Please do! This stuff
    is
    really
...
<p>If you have a <strong>problem with your {{$chocolatey['name']}} account, there was an error with the credits you
        bought
        or you have
