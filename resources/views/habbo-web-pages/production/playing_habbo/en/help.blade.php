...
<p>You may occasionally come across the odd misbehaving {{$chocolatey->hotelName}} . Never fear, help is at hand! On
    this
    page
    we&apos;ll tell
    you what tools work best in tricky situations.</p>
<h2>In a room</h2>
<p>When you&apos;re in a room and another {{$chocolatey->hotelName}} is being out-of-line, click on their avatar and a
    drop-down menu will
...
<p>If <strong>a {{$chocolatey->hotelName}} is saying things which make you feel uncomfortable</strong>, you can put them
    on
    ignore. This is
    an ideal solution for teasing, spamming or when you simply want to say &quot;Bye Felicia!&quot; but don&apos;t know
    how.</p>
<p><img src="{{$chocolatey->hotelUrl}}habbo-web/assets/web-images/report_4.png"
...
<ol>
    ...
    <li>You won&apos;t see what the {{$chocolatey->hotelName}} says anymore. If you want to un-ignore later, click the
        avatar
        again and
        choose <em>Listen</em>.
    </li>
...
<p><strong>In your own rooms, or if you have room rights</strong>, you can decide who can visit the room, and you have
    ...
    general {{$chocolatey->hotelName}} moderation
    and to contribute to a safer and more enjoyable community.</p>
<p>Read more on {{$chocolatey->hotelName}} Helpdesk about <a target="_blank"
...
<p>If <strong>things are getting heated in a room</strong>: {{$chocolatey->hotelName}} s are talking about meeting in
    real
    life, want to video
...
<p><img src="{{$chocolatey->hotelUrl}}habbo-web/assets/web-images/help_button.png" alt="Help button"
        class="align-right"></p>
<p>Another way of doing the same is this:</p>
<ol>
    <li>Click <em>Help</em> in the top right corner.</li>
    <li>Choose <em>Someone is misbehaving</em>. You&apos;ll see a list of all {{$chocolatey->hotelName}} s in the room.
    </li>
...
<ol>
    <li>Click the <em>Report</em> button below the other {{$chocolatey->hotelName}} &apos;s picture in the chat window.
    </li>
    <li>You will be asked for more information about what happened.</li>
    <li>A Moderator will then take appropriate action.</li>
</ol>
<p><img src="{{$chocolatey->hotelUrl}}habbo-web/assets/web-images/report_im.png"
        alt="Reporting a  {{$chocolatey->hotelName}} in personal messaging">
</p>
...
<p>Haven&apos;t read <a href="/playing-habbo/habbo-way">The {{$chocolatey->hotelName}} Way</a> yet? Please do! This
    stuff
    is
    really
    ...
    out.</p>
<h2>How to play</h2>
<p>Looking for <strong>ideas on what to do in {{$chocolatey->hotelName}} </strong>? Read our <a
...
<p>If you have a <strong>problem with your {{$chocolatey->hotelName}} account, there was an error with the credits you
        bought
        or you have
