...
<p>Do you love to chat and hang out with friends? <strong> {{$chocolatey['name']}}
        Groups, forums and
        Roleplaying communities</strong> are a great place to start. Join the army and suit up
    for duty, don your cape and save the universe, wear {{$chocolatey['name']}}
...
<p> {{$chocolatey['name']}} is a <strong>free to play</strong> game, so you can
    explore a vast world of rooms,
    complete quests, chat and win prizes without ever having to pay a thing!</p>
<p>Some in-game &apos;extras&apos; like pets, {{$chocolatey['name']}} Club
    membership, Builders Club membership
    and furniture can be purchased with {{$chocolatey['name']}} Credits. For more
    info about in-game
...
<p>Official {{$chocolatey['name']}} Staff and Moderators monitor the Hotel in
    ...
    to make sure you stay safe on {{$chocolatey['name']}} and on the internet. Read
...
<p>The {{$chocolatey['name']}} world is waiting for you - take a peek, watch this
    video!</p>
<iframe src="//www.youtube.com/embed/Psd3nCVJjPM" frameborder="0" width="640" height="360"></iframe><p>Check out loads
    of more videos on <a href="https://www.youtube.com/user/habbo"
                         target="_blank"> {{$chocolatey['name']}} &apos;s YouTube
        page</a>&#x2026;</p>
