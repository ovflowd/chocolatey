<h1>What is {{$chocolatey->hotelName}} ?</h1>
<p><a href="/registration" class="remove-link"><img
                src="{{$chocolatey->hotelUrl}}habbo-web/assets/web-images/join_now.png" alt="Join now"
                class="align-right"></a>
</p>
<p> {{$chocolatey->hotelName}} is an online vintage pixel-art style virtual community
    where you can
...
<p><img src="{{$chocolatey->hotelUrl}}habbo-web/assets/web-images/ill_15.png" alt="Find your community"
        class="align-right"></p>
<p>Styling your avatar in the most on-trend styles isn&apos;t the only way to have fun
    in {{$chocolatey->hotelName}} . Want to be the architect of the century and <strong>build dazzling
...
<p>Do you love to chat and hang out with friends? <strong> {{$chocolatey->hotelName}}
        Groups, forums and
        Roleplaying communities</strong> are a great place to start. Join the army and suit up
    for duty, don your cape and save the universe, wear {{$chocolatey->hotelName}}
...
<p>Creativity and individuality are welcomed in {{$chocolatey->hotelName}} Every week we have tons of
...
<p> {{$chocolatey->hotelName}} is a <strong>free to play</strong> game, so you can
    explore a vast world of rooms,
    complete quests, chat and win prizes without ever having to pay a thing!</p>
<p>Some in-game &apos;extras&apos; like pets, {{$chocolatey->hotelName}} Club
    membership, Builders Club membership
    and furniture can be purchased with {{$chocolatey->hotelName}} Credits. For more
    info about in-game
    extras, head to the <a href="/shop"> {{$chocolatey->hotelName}} Mall</a>.</p>
<h2>Always here to help&#x2026;</h2>
<p><img src="{{$chocolatey->hotelUrl}}habbo-web/assets/web-images/ill_17.png" alt="Always here to help"
        class="align-right"></p>
<p>Official {{$chocolatey->hotelName}} Staff and Moderators monitor the Hotel in
    real-time so there is
    <strong>always someone nearby to lend a hand</strong> if you need it. You can also do a lot
    to make sure you stay safe on {{$chocolatey->hotelName}} and on the internet. Read
...
<p>The {{$chocolatey->hotelName}} world is waiting for you - take a peek, watch this
    video!</p>
<iframe src="//www.youtube.com/embed/Psd3nCVJjPM" frameborder="0" width="640" height="360"></iframe><p>Check out loads
    of more videos on <a href="https://www.youtube.com/user/habbo"
                         target="_blank"> {{$chocolatey->hotelName}} &apos;s YouTube
        page</a>&#x2026;</p>
<h2>Join {{$chocolatey->hotelName}} !</h2>
<p><a href="/registration" class="remove-link"><img
                src="{{$chocolatey->hotelUrl}}habbo-web/assets/web-images/join_now.png" alt="Join now"
                class="align-right"></a>
</p>
<p>Become a part of the world&apos;s biggest online community for teens. <a
            href="/registration">Join {{$chocolatey->hotelName}}
        now</a>!</p>
