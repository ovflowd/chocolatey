...
<p><a href="/registration" class="remove-link"><img
        src="https://habboo-a.akamaihd.net/c_images/WhatIsHabbo/join_now.png" alt="Join now" class="align-right"></a>
</p>
<p>Habbo is an online vintage pixel-art style virtual community where you can
...
<p>Styling your avatar in the most on-trend styles isn&apos;t the only way to have fun
    in Habbo. Want to be the architect of the century and <strong>build dazzling
...
<p>Do you love to chat and hang out with friends? <strong>Habbo Groups, forums and
    Roleplaying communities</strong> are a great place to start. Join the army and suit up
    for duty, don your cape and save the universe, wear Habbo Couture as you strut
...
<p>Creativity and individuality are welcomed in Habbo! Every week we have tons of
...
<p>Habbo is a <strong>free to play</strong> game, so you can explore a vast world of rooms,
    complete quests, chat and win prizes without ever having to pay a thing!</p>
<p>Some in-game &apos;extras&apos; like pets, Habbo Club membership, Builders Club membership
    and furniture can be purchased with Habbo Credits. For more info about in-game
    extras, head to the <a href="/shop">HabboMall</a>.</p>
<h2>Always here to help&#x2026;</h2>
<p><img src="https://habboo-a.akamaihd.net/c_images/WhatIsHabbo/ill_17.png" alt="Always here to help"
        class="align-right"></p>
<p>Official Habbo Staff and Moderators monitor the Hotel in real-time so there is
    <strong>always someone nearby to lend a hand</strong> if you need it. You can also do a lot
    to make sure you stay safe on Habbo and on the internet. Read our <a href="/playing-habbo/safety">Safety
...
<p>The Habbo world is waiting for you - take a peek, watch this video!</p>
<iframe src="//www.youtube.com/embed/Psd3nCVJjPM" frameborder="0" width="640" height="360"></iframe><p>Check out loads
    of more videos on <a href="https://www.youtube.com/user/habbo" target="_blank">Habbo&apos;s YouTube
        page</a>&#x2026;</p>
<h2>Join Habbo!</h2>
<p><a href="/registration" class="remove-link"><img
        src="https://habboo-a.akamaihd.net/c_images/WhatIsHabbo/join_now.png" alt="Join now" class="align-right"></a>
</p>
<p>Become a part of the world&apos;s biggest online community for teens. <a href="/registration">Join Habbo
    now</a>!</p>
