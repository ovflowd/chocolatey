...
<p><img src="{{$chocolatey->url}}habbo-web/assets/web-images/navigator.png" alt="Navigator" class="align-right"></p>
<h3>Explore rooms</h3>
<p>Click the Navigator and choose one of the public rooms where you can chat with other {{$chocolatey->name}} s.</p>
<hr>
<p><img src="{{$chocolatey->url}}habbo-web/assets/web-images/askfriend.png" alt="Ask to be friend" class="align-right">
</p>
<h3>Make friends</h3>
<p>Click on a {{$chocolatey->name}} , ask them to be your friend or give them respect!</p>
<hr>
<p><img src="{{$chocolatey->url}}habbo-web/assets/web-images/citizenship.png"
...
<p>To get to know the Hotel a bit better, start by clicking on the Help tool in the the top right corner in the
    hotel.</p>
<hr>
<p><img src="{{$chocolatey->url}}habbo-web/assets/web-images/gamehub.png" alt="Game Hub" class="align-right"></p>
