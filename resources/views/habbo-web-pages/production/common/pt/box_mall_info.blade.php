...
<p>O {{$chocolatey->name}} Hotel tem <strong>limites de compra</strong> para cada m&#xE9;todo de pagamento. Voc&#xEA; pode encontrar
    esses <a target="_blank"
        ...
        na Ferramenta de Ajuda {{$chocolatey->name}}</a>.</p>
<p>Tem alguma d&#xFA;vida sobre a sua <strong>conta {{$chocolatey->name}}, compras ou algum recurso do Hotel?</strong> Encontre as
