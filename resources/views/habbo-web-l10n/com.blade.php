{
  ...
  "FOOTER_COPYRIGHT": "© @{{year}} {{$chocolatey['name']}} Isn't a Trademark of Sulake Corporation Oy. This website hasn't any filiation with Sulake.",
  ...
  "FOOTER_ADVERTISERS_LINK": "mailto:{{$chocolatey['contact']}}",
  ...
  "CREDITS_CONFIRM_DISCLAIMER_V2_MERCHANT_INFO": "{{$chocolatey['name']}}-coins can be used on {{$chocolatey['name']}}",
