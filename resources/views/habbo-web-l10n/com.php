{
  ...
  "REGISTRATION_SAFETY": "Welcome to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>! Have fun and <a href=\"/playing-habbo/safety\" target=\"_blank\">stay safe</a>!",
  ...
  "OK_BUTTON": "OK",
  "PHOTOS_TITLE": "Photos from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  ...
  "USER_AVATAR_BAN_TEXT_WITH_GUIDE": "Your avatar <b>{{avatarName}}</b> has been banned from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> for this reason: <b>{{reason}}</b>. You can log in again on <b>{{expiryTime}}</b>. <p>You can appeal your ban at the <a href=\"https://help.habbo.com\" target=\"_blank\"><?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Helpdesk</a>.</p>",
  ...
  "USER_IDENTITY_BAN_TEXT_WITH_GUIDE": "You have been banned from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> for this reason: <b>{{reason}}</b>. You can log in again on <b>{{expiryTime}}</b>. <p>You can appeal your ban at the <a href=\"https://help.habbo.com\" target=\"_blank\"><?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Helpdesk</a>.</p>",
  ...
  "FOLLOW_HABBO": "Follow <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  ...
  "SHOP_NOTICE_PROVIDER_TITLE": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> is owned and operated by:",
  ...
  "PROFILE_JOINED": "Joined <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> on {{date}}",
  ...
  "USER_IDENTITY_PERMANENT_BAN_TEXT_WITH_GUIDE": "You have been permanently banned from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> for this reason: <b>{{reason}}</b>. <p>You can appeal your ban at the <a href=\"https://help.habbo.com\" target=\"_blank\"><?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Helpdesk</a>.</p>",
  "HEAD_TITLE_NOT_FOUND": "Not found",
  "SHOP_PAYMENT_DETAILS": "Check your details",
  "NAVIGATION_COMMUNITY": "Community",
  "EU_COOKIE_BANNER": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> uses its own and third-party cookies in order to provide a better service and display advertisement that fits your preferences. By using our website you agree to our cookie policy.",
  ...
  "PLAYING_HABBO_WHAT_IS_HABBO_TAB": "What is <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>?",
  "USER_AVATAR_PERMANENT_BAN_TEXT_WITH_GUIDE": "Your avatar <b>{{avatarName}}</b> has been banned from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> for this reason: <b>{{reason}}</b>. <p>You can appeal your ban at the <a href=\"https://help.habbo.com\" target=\"_blank\"><?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Helpdesk</a>.</p>",
  ...
  "PHOTOS_DESCRIPTION": "Have a look at some of the great moments captured by <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>s around the hotel.",
  ...
  "PARTNER_REGISTRATION_HELP": "Want access to loads of free web games? Register this e-mail and password to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>'s trusted partner <a href=\"https://www.idcgames.com\" target=\"_blank\">IDC/Games</a> at the same time!",
  ...
  "SETTINGS_OFFLINE_MESSAGING_ENABLED_DESCRIPTION": "If you use Pocket <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>, friends will always be able to send you private messages.",
  ...
  "NEW_USER_AGREEMENT_INFO_TEXT": "It's been a while since you logged in to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>! Please review the latest version of our <a href=\"https://help.habbo.com/entries/23096348-Terms-of-Service-and-Privacy-Policy\" target=\"_blank\">Terms of Service, Privacy Policy and Cookie Policy</a>.",
  "READ_MORE": "Read more",
  ...
  "EMAIL_NEW_HELP": "You'll need to use this email address to log in to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> in the future. Please use a valid address.",
  ...
  "ROOMS_DESCRIPTION": "Check out some of the most popular rooms within <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> right now!",
  "SHOP_INFO_TAB": "Mall Info",
  "SHOP_PAYMENTMETHOD_TITLE_ES_SMS_TIMWE_PE": "<B>SMS</B> (Movistar)",
  "REPORT_EXPLANATION": "Please tell us why you think this image should be removed from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>.",
  ...
  "FOOTER_COPYRIGHT": "© 2004 - {{year}} Sulake Corporation Oy. <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> is a registered trademark of Sulake Corporation Oy in the European Union, the USA, Japan, the People's Republic of China and various other jurisdictions. All rights reserved.",
  ...
  "EMAIL_REPORT_UNAUTHORIZED_SUCCESS": "Email address added to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> block list.",
  ...
  "HEAD_TITLE_HABBO15": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> 15th birthday!",
  ...
  "SHOP_CREDIT_CARD_SMALLPRINT": "Credit card payment service provided by Adyen. <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> does not store your credit card information. If you need assistance with credit card purchases, please contact our <a href=\"https://help.habbo.com\">Customer Support</a>.",
  ...
  "MODERATION_MESSAGE_INSTRUCTIONS": "Please read the <a href=\"/playing-habbo/habbo-way\"><?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Way</a> to lean how to keep your photos classy!",
  "SHOP_PAYMENTMETHOD_SMALLPRINT_ES_SMS_TIMWE_DOR": "Standard text message fee will also be charged depending on operator and mobile phone plan. You will be charged for this purchase on your next phone bill. If you are on a prepaid balance, the sum will be subtracted from your balance immediately. The quoted price is charged for each SMS that is requested.<BR/> <BR/>\r\n\r\nThere is <A HREF=\"https://help.habbo.com/entries/347508-What-are-the-spending-limits-on-Habbo-\" TARGET=\"_blank\"> spending limit information</A> available on our Help pages. <BR/> <BR/>\r\n\r\nSMS payment service provided by PARTNER. If you need assistance with mobile purchases, please contact PARTNER CUSTOMER SERVICE CONTACT. <BR/> <BR/>",
  "FORM_NAME_LABEL": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> name",
  "SHOP_HISTORY_TAB": "My history",
  "POLICIES_MARKETING": "Keep me updated about the latest <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> happenings, news and gossip!",
  ...
  "NOT_FOUND_PAGE_TEXT": "Frank can't find the page you're looking for. Please check the URL or try starting over from the <a href=\"/\"><?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> front page.</a>",
  ...
  "INTERS_DESCRIPTION": "Ads help keep <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> free!",
  ...
  "ACCOUNT_SECURITY_TRUSTED_LOCATIONS_DESCRIPTION": "We <b>won't ask safety questions for logins on trusted locations</b>. You can save a location as trusted when you log into <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> with a new device and a new IP address and answer the security questions correctly.<br><br>You should <b>reset your trusted locations if you have unlocked your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> account on public computers</b> you no longer want to use.",
  ...
  "HEAD_TITLE_PLAYING_HABBO_WHAT_IS_HABBO": "What is <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>?",
  ...
  "HOTEL_CLOSED_DESCRIPTION": "Even pixel staff need their beauty sleep! The Hotel is currently closed, but will reopen again soon. Check out some of the amazing stuff on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> while you wait:",
  "SHOP_SMALLPRINT_TITLE": "Important notice",
  "SETTINGS_ENABLE_NEWSLETTER_LABEL": "Yes! I want the latest <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> news sent straight to my e-mail inbox.",
  ...
  "LIMIT_EXCEEDED": "Sorry, your payment couldn't be processed. Note that <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> has different spending limits for different payment options.\r\n\r\nPlease try again after a while, or use an alternative payment method. For further assistance, please refer to our Customer Support & Helpdesk pages.",
  ...
  "SETTINGS_ENABLE_FRIEND_REQUESTS_LABEL": "Other <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>s can send me friend requests",
  ...
  "SHOP_CREDITS_DESCRIPTION": "Get {{value}} credits and {{value}} diamonds! You can use them in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Hotel to purchase all sorts of amazing things, like furni, pets and even <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club memberships!",
  ...
  "ERROR_EMAIL_REGISTRATION_USED": "The email you gave is already in use. If you're trying to create a new character, please log in with your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> account and create a new character.",
  ...
  "LOGIN_RPX_REGISTRATION_DISABLED": "There is no <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> account connected to that Google, Twitter, Yahoo or Microsoft account. Please check your login or register a new <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> account with email or Facebook.",
  ...
  "CLIENT_ERROR_MOBILE": "If you are on an iPad, iPhone or an Android device, you can get <a href=\"https://itunes.apple.com/app/id794866182\" target=\"_blank\"><?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> for iOS</a> on the App Store or <a href=\"https://play.google.com/store/apps/details?id=air.com.sulake.habboair\" target=\"_blank\"><?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> for Android</a> on Google Play.",
  ...
  "USER_AVATAR_PERMANENT_BAN_TEXT": "Your avatar <b>{{avatarName}}</b> has been banned from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> for this reason: <b>{{reason}}</b>.",
  ...
  "HEAD_TITLE_NEWS": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> - Virtual World, Avatar Chat, and Pixel Art",
  "MONTH_APRIL": "April",
  "MONTH_JULY": "July",
  ...
  "ERROR_BIRTHDATE_AGE": "You are not eligible to register for <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. Please check our Terms of Service.",
  "HEAD_TITLE_PLAYING_HABBO_HABBO_WAY": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Way",
  ...
  "SHOP_DOUBLE_CREDITS_DESCRIPTION": "For a limited time only - get 2 x {{value}} credits and 2 x {{value}} diamonds! Double the credits, double the fun! You can use credits in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Hotel to purchase all sorts of amazing things, like furni, pets and even <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club memberships.",
  ...
  "USER_IDENTITY_PERMANENT_BAN_TEXT": "You have been permanently banned from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> for this reason: <b>{{reason}}</b>.",
  ...
  "INTERS_INSTRUCTION": "Join <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club or Builders Club to play without adverts.",
  ...
  "CAMPAIGN_MESSAGES_TITLE": "Minimail from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  ...
  "MAINTENANCE_CONTENT": "Sorry! <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> is being worked on at the moment. We'll be back soon. We promise.",
  ...
  "ACCOUNT_SECURITY_PASSWORD_DESCRIPTION": "Please enter your current <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> password to save the settings.",
  ...
  "ERROR_SERVER_MAINTENANCE": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> is under a short maintenance break. We'll be back soon!",
  "LOCAL_REGISTER_BANNER_PT": "Entre na sua comunidade local em",
  "OPTOUT_SUCCESS": "Unsubscribe successful! You will no longer receive news about campaigns etc. from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>.",
  "AVATAR_SELECTION_BANNED": "This avatar is banned from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>.",
  ...
  "HOME_PAGE_FALLBACK_TITLE": "Looking for {{profileName}}'s <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> homepage?",
  ...
  "PLAYING_HABBO_HABBO_WAY_TAB": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Way",
  ...
  "CLIENT_ERROR_TITLE": "Oh bobba, can't <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>!",
  "HOTEL_CLOSED_TITLE": "Hotel Closed",
  "LIKE": "Like",
  "NAVIGATION_PLAYING_HABBO": "Playing <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  "FORCED_EMAIL_CHANGE_TEXT": "This email address has been reported as belonging to someone else. To access your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> account, you need to change your login email.",
  "USER_AVATAR_BAN_TEXT": "Your avatar <b>{{avatarName}}</b> has been banned from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> for this reason: <b>{{reason}}</b>. You can log in again on <b>{{expiryTime}}</b>.",
  "RELOAD_TITLE": "Disconnected!",
  "USER_IDENTITY_BAN_TEXT": "You have been banned from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> for this reason: <b>{{reason}}</b>. You can log in again on <b>{{expiryTime}}</b>.",
  ...
  "LOGIN_REGISTER": "Don't have an account? Join <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>!",
  ...
  "CONSOLE_WARNING": "Welcome to AzureWEB the ultimate experience with <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>WEB. We from AzureWEB team wish to you a good experience with it. Report bugs on our GitHub (https://github.com/sant0ro/azureWEB).",
  ...
  "SHOP_TITLE": "Buy <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> credits and more",
  ...
  "TX_HISTORY_DESCRIPTION_HTK_IT": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via land line",
  "TX_HISTORY_DESCRIPTION_HTK_IR": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via land line",
  "CREDITS_CASHCARDAU_PRICES_NOTE": "Please note that not all the stores carry <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Prepaid Cards of all values, or the stores could be out of stock. To be sure, call your local store in advance.",
  "CREDITS_PURCHASE_OPTIONS_PREPAID_HEADER": "Prepaid",
  "CREDITS_CASHCARDAU_PRICES_SUBTITLE": "Australia:",
  "COINS_NAVI_SELECT_COUNTRY": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits are the currency used in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. You can use them to buy all kinds of things, from rubber ducks and sofas, to HC membership and teleports.",
  "HEADING_HABBOCLUB_PUBLICROOM_ACCESS": "4. Access All Areas",
  "TX_HISTORY_DESCRIPTION_HTK_IE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via land line",
  "CREDITOFFERS_DESCRIPTION": "Now you can collect <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits by completing selected offers and surveys, here's how; <p/> <ol> <li>Select the amount of Credits you'd like to earn by clicking on an offer</li> <li>Follow the instructions on how to earn your Credits</li> <li>Keep track of when your Credits will be delivered by checking your status through 'Support' link on the Offer Wall below</li> <li>You will see the Credits in your <a href=\"history\" target=\"_blank\">Purse</a></li> </ol> <p/> ...and then have fun spending your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits!<p/>If you are missing Credits for completed offers, please contact the offer provider through the 'Support' link on the Offer Wall below.<br/><br/>",
  ...
  "TX_HISTORY_DESCRIPTION_SCRATCHCARDS_CA": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  "COLLECTIBLES_PURCHASE_TITLE": "Purchase Collectible",
  "PURSE_INFO_LOGIN_REQUIRED": "You need to log-in to see the purse",
  "CREDITS_PROMO_TEXT_2": "All legitimate ways to buy <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits are to the left. Buying them elsewhere could get you ripped off and MAY get you banned.",
  "CREDITS_PROMO_TEXT_1": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits are the currency used in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. You can use them to buy all kinds of things, from Rubber Ducks and Sofas, to HC membership and Teleports.",
  ...
  "TITLE_COINS": "Get virtual items, <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club membership and more with <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits!",
  "TX_HISTORY_DESCRIPTION_DND": "Voucher Capades  dnD voucher redemption",
  "CREDITS_SUBSCRIPTION_CANCEL_TIME": "Canceled at:",
  "CREDITS_TOOLTIP_DESCRIPTION": "{0} <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits allow you to purchase AWESOME things in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>, like furni, pets and <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club memberships!",
  "CREDITS_CAMPAIGN_BANNER_BACKTOSCHOOL_BUY": "1 + 1 = 4? Double Credits for all!",
  "REDEEM_BUTTON_TEXT": "Redeem",
  "TX_HISTORY_DESCRIPTION_WORLDPAY": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via Worldpay",
  "CREDITS_SUBSCRIPTION_ORDER_SUBMIT": "Continue",
  "HABBOCLUB_BUY_CONFIRM_BASIC_DAYS": "You are purchasing: <b>{0} days of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club</b>",
  "TX_HISTORY_DESCRIPTION_BIBIT": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via Credit Card",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_WIN_BTCELLNET": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  ...
  "TITLE_COINS_PROMO": "What are <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits?",
  "CREDITS_REGISTRATION_PURCHASE_HEADER": "Join <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club",
  ...
  "HABBOCLUB_STARTING_PRICE_NOTICE": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club membership starts from {0} Credits",
  "TX_HISTORY_DESCRIPTION_PREPAID_WALMART": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card",
  ...
  "COINS_CASHCARDUS_INSTRUCTIONS2": "Buy a <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Cash Card",
  ...
  "HABBO_ID_ERROR_USER_NOT_FOUND": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> with that name was not found",
  "CREDITS_REGISTRATION_CONTINUE": "Continue",
  "HABBOCLUB_BUY_SUCCESS_INFO_UPGRADE": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club subscription has been activated.",
  "CREDITS_CONFIRM_BRAINTREE_DETAILS_HEADER": "Credit Card Payment",
  "PIXELS_CONTENT_FAQ_LINK": "/help",
  "CREDITS_CASHCARDPH_PRICES_NOTE": "Please note that not all the stores carry <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Scratch Cards of both values, and that the stores could be out of stock. To be sure, call your local store in advance.",
  "CREDITS_CAMPAIGN_BANNER_MONSTERPLANT_STATUS_PRE": "You have purchased",
  "TX_HISTORY_DESCRIPTION_SMS_MOB": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "TITLE_PURSE": "Purse",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_MACSEAST_25": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  ...
  "CREDITS_CASHCARDMY_INSTRUCTIONS2": "Buy a <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Scratch Card",
  ...
  "CREDITS_CASHCARDUS_PRICES_SUBTITLE": "...and access to the most exciting <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> benefits, like HC and virtual furniture. Visit our Shop by entering <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Hotel and clicking on the purse icon and see what Credits can get you.",
  ...
  "SUBSCRIPTION_CLOTHES_NOTICE_TITLE": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club purchase with clothes",
  ...
  "HABBOCLUB_STARTPRICE_UNAVAILABLE_NOTICE": "Not able to determine the <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> club price.",
  "TX_HISTORY_DESCRIPTION_HTK_DE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via land line",
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_ORANGE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "CREDITS_CASHCARDCA_PRICES_LIST": "<li><b>50</b> for <b>C$10</b></li> <li><b>125</b> for <b>C$25</b></li>",
  "HABBOCLUB_BUY_CONFIRM_VIP_BUY": "You are about to subscribe to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> HC!",
  ...
  "TX_HISTORY_DESCRIPTION_CA_MONSTERS_PROMO_ 07": "Monsters of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> (promotion)",
  ...
  "CREDITOFFERS_DESCRIPTION_TITLE": "Collect <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits",
  "CREDITS_CREDIT_OFFERS_TITLE": "Collect <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits by completing special offers and surveys",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_VODAFONE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "TX_HISTORY_DESCRIPTION_PREPAID_AU": "Prepaid Card purchase",
  "COLLECTIBLES_BUTTON_REAUTHENTICATE": "Re-log in",
  "TX_HISTORY_DESCRIPTION_CLUB_HABBO": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club payment",
  ...
  "TX_HISTORY_DESCRIPTION_HTK_BE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via land line",
  "HABBOCLUB_BUY_NORMALHEADER_1": "1 month",
  "HABBOCLUB_BUY_SUCCESS_INFO_VIP_NEW": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club subscription has been activated.",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_BLACKHAWK": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Prepaid Card redemption",
  "CREDITS_CATEGORY_QUICK_AND_EASY": "Quick and Easy",
  "CREDITS_CASHCARDMY_PRICES_NOTE": "Please note that not all the stores carry <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Scratch Cards of both values, and that the stores could be out of stock. To be sure, call your local store in advance.",
  "TX_HISTORY_DESCRIPTION_OFFERS_SOMETRICS_US_SS": "Credit Offer",
  "CREDITS_SUCCESS_SUMMARY_BACK_TO_HABBO": "Back to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  "TX_HISTORY_DESCRIPTION_PREPAID_711_25": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  ...
  "HABBOCLUB_BUY_CONFIRM_UPGRADE": "You are about to upgrade your existing <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club subscription. Cool! The upgrade will convert your remaining Club Subscription to HC based on the price difference between the subscriptions, and then give you {0} Credits worth of HC.",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_MACSEAST": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_SG_45": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card",
  "CREDITS_BRAINTREE_PROCESSED_BY": "Payment processed by",
  "HABBOCLUB_GIFTPOINTS": "Gift points left: {0}",
  "INFO_HABBOCLUB_UPGRADE_DISCLAIMER": "Disclaimer: 600 buddies do not come included with purchase of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club.",
  ...
  "HABBOCLUB_BUY_GETCREDITSINFO": "Get some Credits and be part of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club.",
  "CREDITS_CASHCARDSG_STORES_LIST": "Get collectable <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Scratch Cards in comic/computer/book stores, as well as Comics Connection, Cheers and Esso Cheers outlets. Find a store near you with our <a href=\"http://promo.habbohotel.com.sg/storelocator/\">Store Locator</a>",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_WIN_VODAFONE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  ...
  "INFO_HABBOCLUB_HEADERTEXT": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club is our HC members-only club - absolutely no riff-raff admitted! Members enjoy a wide range of benefits, including exclusive clothes, free gifts and an extended Friends List. See below for all the sparkly, attractive reasons to join.",
  ...
  "HABBOCLUB_BUY_CONFIRM_UPGRADE_DAYSNOW": "You now have: <b>{0} days of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club</b>",
  ...
  "HABBO_ID_ERROR_NAME_REQUIRED": "Please enter <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> name",
  "CREDITS_CANCELED_HEADER": "Payment canceled",
  "CREDITS_HABBO_ID_CAPTION": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> ID for user",
  ...
  "HABBOCLUB_LOGINNEEDED": "Please sign in to see your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club status",
  ...
  "COLLECTIBLES_DESCRIPTION_2009_1": "Found in frozen ice. This bizarre creature holds many secrets. Carbon dating revealed nothing helpful except its age: Very old. It makes you wonder what other dark secrets are hiding in the <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> oceans...",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_VODAFONE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "PURSE_BALANCE_AMOUNT": "{0} Credits",
  "TX_HISTORY_DESCRIPTION_SMS_MOBIE_METEOR": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "HABBOCLUB_BUY_SUCCESS_INFO_BASIC_EXTEND": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club subscription has been extended.",
  ...
  "COINS_CONFIRM_LISTING_RECIPIENT_HEADER": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Name",
  ...
  "TX_HISTORY_DESCRIPTION_SCRATCHCARD_CA": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  ...
  "TX_HISTORY_DESCRIPTION_HTK_NL": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via land line",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_TMOBILE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "CREDITS_CAMPAIGN_BANNER_EASTERDOUBLE_BUY": "DOUBLE CREDITS AND EASTER RARE!",
  "CREDITS_TERMS_DESC": "Terms & Conditions apply",
  "NAVI_SHOW": "",
  "COINS_MOREINFO_LINK": "More info on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits",
  "TX_HISTORY_DESCRIPTION_CROSS_SITE_HHAU": "Transfered from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Australia",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_INCOMM_AU": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  ...
  "HABBO_ID_RESULT": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> account for user {1}: <b>{0}</b>",
  ...
  "HABBO_ID_FORM_NAME": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> name:",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_BILLING": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_BACKUP": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "TITLE_CREDITS_PROMO": "About <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits",
  ...
  "TX_HISTORY_DESCRIPTION_PAYSAFE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via Paysafe",
  ...
  "SUBSCRIPTION_CONFIRM_ONEMONTH": "{0} <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club month ({1} days) costs {2} Credits. You have: {3} Credits.",
  ...
  "CREDITS_REGISTRATION_PURCHASED_CONTINUE_HEADER": "Congrats! You are now a <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club member.",
  "SUBSCRIPTION_REAUTHENTICATE_LINK": "Go",
  "TX_HISTORY_DESCRIPTION_CROSS_SITE_HHCA": "Transfered from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Canada",
  ...
  "CREDITS_MOREINFO_LINK": "More info on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits",
  "NAVI_CREDIT_OFFERS": "Earn Credits",
  "CREDITS_CAMPAIGN_BANNER_HABBOWEEN2012_TITLE": "Habboween has arrived!",
  "SUBSCRIPTION_CONFIRM_SEVERALMONTHS": "{0} <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club months ({1} days) costs {2} Credits. You have: {3} Credits.",
  "HABBO_ID_ID_FOR_USER": "The <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> ID number for",
  ...
  "SUBSCRIPTION_ACTIVE_BODY": "Now you'll be able to enjoy all the HC benefits of being a <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club member.",
  ...
  "CREDITS_CREDIT_OFFERS_HEADER": "Collect <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MOB_ORANGE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_O2": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "CREDITS_CAMPAIGN_BANNER_HABBOWEEN2012_TEXT": "Receive 5 Pumpkins for every 1 Credit you buy! Pumpkins are the ONLY way to get some of the latest <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>ween costumes and furni!",
  ...
  "CREDITS_DESCRIPTION": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits",
  ...
  "CREDITS_CONFIRM_LISTING_RECIPIENT_HEADER": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Name",
  ...
  "CREDITS_FAILURE_BACK_TO_HABBO": "Back to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_ORANGE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  ...
  "CREDITS_CASHCARDSG_INSTRUCTIONS2": "Buy a <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Scratch Card",
  ...
  "TX_HISTORY_DESCRIPTION_INCOMM_7ELEVEN_TEST": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Prepaid Card redemption",
  "CREDITS_FOOTER_DISCLAIMER": "Always ask your parents and/or bill-payer's permission first.<br> If you don't and the payment is later cancelled or declined, you'll be banned.<br> All legitimate ways to buy Credits are shown here. Buying them elsewhere may get you ripped off and banned.<br> The digital content is delivered immediately upon confirmation of payment and by purchase it is accepted that there is no right of withdrawal. <br> <br> Service provider:<br> Sulake Corporation Oy<br> Kaarlenkatu 11, 00530 Helsinki<br> FINLAND<br> Business ID: 1603628-6<br> <a onclick=\"openOrFocusHelp(this); return false\" target=\"habbohelp\" href=\"https://help.habbo.com/anonymous_requests/new\">Contact</a> | <a onclick=\"openOrFocusHelp(this); return false\" target=\"habbohelp\" href=\"https://help.habbo.com/entries/23096348-Terms-of-Service-and-Privacy-Policy\">Terms and conditions</a>",
  "HABBOCLUB_BUY_GETCOINSINFO": "Get some Credits and be part of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club.",
  "PURSE_COINS_AMOUNT_NEGATIVE": "Oh dear! There is something wrong with your purse.",
  "COINS_SAFETY_TEXT_1": "Always ask permission from your parent or guardian before you buy <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits. If you do not do this and the payment is later canceled or declined, you will be permanently banned.",
  "HABBOCLUB_INSUFFIENT_COINS_NOTICE": "To join <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club you first need to buy some <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits:",
  ...
  "CREDITS_CONFIRM_DISCLAIMER_TEXT_ZONG": "If you do not receive permission to use this payment method and the payment is later canceled or declined, you will be banned. Please note that the charge on the phone bill may appear as \"Zong\", our partner in SMS billing. Please ensure that the bill payer recognizes \"Zong\" as your purchase of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits.",
  ...
  "CREDITS_NAVI_SELECT_COUNTRY": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits are the currency used in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. You can use them to buy all kinds of things, from rubber ducks and sofas, to HC membership, and teleports.",
  "COINS_SAFETY_TEXT_2": "It is better to ask questions first, than be banned later ;)",
  "HABBOCLUB_BUY_CONFIRM_BASIC_BUY": "You are about to subscribe to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club. Cool!",
  ...
  "COINS_SUCCESS_SUMMARY_BACK_TO_HABBO": "Back to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  "CREDITS_CASHCARDMY_STORES_TITLE": "",
  "HABBOCLUB_BUY_SUCCESS_INFO_VIP_EXTEND": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club subscription has been extended.",
  ...
  "HABBOCLUB_BUY_COINS_BUTTON": "Purchase <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_WIN_ORANGE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "COINS_SUCCESS_HEADER": "Congratulations!",
  "TX_HISTORY_DESCRIPTION_SMS_TMOBILE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "CREDITS_BUILDERS_CLUB_ACTIVE_TEXT": "Your subscription is active.",
  "TX_HISTORY_DESCRIPTION_PREPAID_BI_GET1": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  "COINS_FAILURE_INSTRUCTIONS": "Please go back and try the purchase again.",
  "CREDITS_TYPES_OTHER": "or",
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_3": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "CREDITS_HABBO_ID_NOT_LOGGED_IN": "Log in to see your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> ID",
  ...
  "HABBOCLUB_BUY_SUCCESS_INFO_BASIC_NEW": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club subscription has been activated.",
  "HABBOCLUB_CATALOG_NEXT": "Next",
  "REDEEM_INFO_REAUTHENTICATE": "Please reauthenticate to redeem a voucher.",
  "COINS_PROMO_TEXT_2": "Life is just more fun with <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits.",
  ...
  "COINS_PROMO_TEXT_1": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits are the currency used in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. You can use them to buy all kinds of things, from rubber ducks and sofas, to HC membership and teleports.",
  "NAVI_PIXELS": "Pixels",
  ...
  "COINS_CANCELED_BACK_TO_HABBO": "Back to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  ...
  "CREDITS_CONFIRM_DISCLAIMER_V2_MERCHANT_INFO": "Habbo-coins can be used on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Hotel, which is provided by Sulake Corporation Oy, Porkkalankatu 1, FIN-00180 Helsinki, VAT FI16036286",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_3": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  ...
  "TX_HISTORY_DESCRIPTION_CVS": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card from CVS",
  "PURSE_REDEEM_CODE_ALLREADY_REDEEMED": "Code has already been used.",
  "TX_HISTORY_DESCRIPTION_PREPAID_MACSWEST_25": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MBLOX_O2": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "CREDITS_ABTESTING_BOKU": "true",
  "FURNITRADE_HISTORY_TITLE_FROM": "Original Owner",
  "INFO_HABBOCLUB_UPGRADE_HOME": "Join <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club and say goodbye to homepage ads! And this means you can make the most of the HC skins and backgrounds too.",
  ...
  "HABBO_ID_FORM_ENTER_NAME": "Enter your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> name below to see your ID number:",
  ...
  "TX_HISTORY_DESCRIPTION_HTK_UK": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via land line",
  "INFO_HABBOCLUB_TRYOUT_LINK": "Try out <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club clothes for yourself!",
  "PIXELS_CONTENT_INFO_LI1": "1. Sign into <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> once a day",
  "TX_HISTORY_DESCRIPTION_XMAS_CAL_07": "Xmas Calendar 2007 (promotion)",
  "PIXELS_CONTENT_INFO_LI2": "2. Get rewarded for spending time each day in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>- the longer you stay the more you earn!",
  ...
  "PIXELS_CONTENT_INFO_LI4": "4. Join <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club!",
  ...
  "TX_HISTORY_DESCRIPTION_HTK_SINGLEDROP": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via land line",
  ...
  "CREDITOFFERS_TITLE_INFO": "Collect <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits by completing special offers and surveys",
  "TX_HISTORY_DESCRIPTION_CA_MONSTERS_PROMO_07": "Monsters of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> 2007 (promotion)",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MOB_3": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "CREDITS_CASHCARDAU_INSTRUCTIONS3": "Enter the code below",
  "TX_HISTORY_DESCRIPTION_SMS_WIN_TMOBILE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "CREDITS_CASHCARDAU_INSTRUCTIONS2": "Purchase your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Game Card",
  ...
  "HABBOCLUB_MEMBERSHIP_NO": "You are not a member of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club",
  ...
  "CREDITS_CASHCARDPH_INSTRUCTIONS2": "Buy a <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Scratch Card",
  ...
  "NAVI_HABBOCLUB_TRYOUT": "Join <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club!",
  "CREDITS_CASHCARDCA_PRICES_TITLE": "Prices",
  "CREDITS_LOYALTY_POINTS_HEADER": "Diamonds",
  "CREDITS_CANCELED_BACK_TO_HABBO": "Back to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_BHNCA": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  ...
  "CREDITS_CONFIRM_DISCLAIMER_TEXT": "Please note that the charge on the credit card bill may appear as \"WorldPay\" our billing partner. Please ensure that the bill payer recognizes \"WorldPay\" as your purchase of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits.",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_INCOMM_UK": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  "PURSE_REDEEM_CODE_FAILED_UNKNOWN_TR_SYSTEM": "The code you entered {0} is not valid for <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>.com.  If you''re experiencing problems, please contact Customer Support.",
  "CREDITS_PENDING_SUMMARY_HEADER": "Please print this information for your reference",
  "TX_HISTORY_DESCRIPTION_SMS_MOBIE_VODAFONE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  "CREDITS_CAMPAIGN_BANNER_DIAMONDS2_BUY": "This weekend only, Get DOUBLE DIAMONDS!",
  "TX_HISTORY_DESCRIPTION_SMS_MOB_O2": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  ...
  "HABBOCLUB_MEMBERSHIP_YES": "You are a member of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club",
  "TX_HISTORY_DESCRIPTION_SMS_MOB_TMOBILE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  ...
  "TX_HISTORY_DESCRIPTION_SMS_MOB_VODAFONE": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  ...
  "TX_HISTORY_DESCRIPTION_PREPAID_MACSWEST": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  "TX_HISTORY_DESCRIPTION_PETRO_CA": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> eVoucher",
  "SUBSCRIPTION_ACTIVE_TITLE": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club membership is now activated.",
  ...
  "HABBOCLUB_BUY_CONFIRM_VIP_EXTEND": "You are about to extend your subscription to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club. Glad to see you continue your subscription!",
  "CREDITS_BUTTON_SUBSCRIBE": "Subscribe",
  "TX_HISTORY_DESCRIPTION_AIR2WEB_CINGULAR": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via Cingular PSMS",
  ...
  "TX_HISTORY_DESCRIPTION_CROSS_SITE_HHUK": "Transfered from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> UK",
  "PURSE_REDEEM": "Enter voucher code:",
  "TX_HISTORY_TITLE_AMOUNT": "Activity",
  "REDEEM_TEXT_BALANCE": "Balance:",
  "COINS_FAILURE_BACK_TO_HABBO": "Back to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  ...
  "COINS_CATEGORY_SUBSCRIPTION": "Get <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits!",
  ...
  "CREDITS_SAFETY_TEXT_1": "Always ask permission from your parent or guardian before you buy <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits. If you do not do this and the payment is later canceled or declined, you will be permanently banned.",
  "TX_HISTORY_DESCRIPTION_CREDITCARDS_IS_CA": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via Credit Card",
  "HABBOCLUB_BUY_HEADER_INFOCOL_VIPSUB": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club",
  "CREDITS_BRAINTREE_FAILURE_MESSAGE_81725": "",
  "TX_HISTORY_NAVI_PREV": "Previous",
  "COINS_CASHCARDUS_PRICES_NOTE": "Please note that not all the stores carry <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Prepaid Cards of both values, and that the stores could be out of stock. To be sure, call your local store in advance.",
  ...
  "TITLE_CREDITS": "Get <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits!",
  "TX_HISTORY_DESCRIPTION_SMS_MOBIE_O2": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via SMS",
  ...
  "NAVI_HABBOCLUB": "VIP",
  "INFO_HABBOCLUB_ROOM_LAYOUT": "Special Guest Room layouts, only for <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club members. Perfect for showing off your new furni!",
  "CREDITS_CASHCARDPH_STORES_LIST": "Get collectable <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Scratch Cards at Netopia, Excel, Compass Internet, Station 168/I-Hooked, and BeConnected Internet cafes. Also at Robinsons Departmental Stores now! Find a store near you with our <a href=\"http://promo.habbohotel.com.sg/storelocator/\">Store Locator</a>.",
  ...
  "TX_HISTORY_DESCRIPTION_SPLASHPLASTIC": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via Splashplastic",
  "COINS_CASHCARDCA_STORES_LIST": "<table> <tr>",
  "TX_HISTORY_DESCRIPTION_CROSS_SITE_HHSG": "Transfered from <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Singapore",
  ...
  "HABBOCLUB_BUY_CONFIRM_BASIC_EXTEND": "You are about to extend your subscription to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club. Glad to see you continue your subscription!",
  "HABBOCLUB_BUY_CREDITS_BUTTON": "Purchase <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits",
  ...
  "HABBOCLUB_INSUFFIENT_CREDITS_NOTICE": "To join <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club you first need to buy some <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits:",
  ...
  "CREDITS_CONFIRM_DISCLAIMER_TEXT_BIBIT_SUB_START": "Please note that the charge on the credit card bill may appear as \"WorldPay\" our billing partner. Please ensure that the bill payer recognizes \"WorldPay\" as your purchase of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits. The subscription will be charged on the credit card every 30 days until canceled.",
  ...
  "SUBSCRIPTION_TITLE": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> CLUB",
  ...
  "CREDITS_PARENTS-GUIDE-TO-HABBO_LINK": "Parents' Guide to <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  "TX_HISTORY_DESCRIPTION_FREECODES_NEWERA": "Bonus code",
  "CREDITS_CAMPAIGN_BANNER_LOYALTYBASIC_BUY": "Want More Credits, Rares, and <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club?",
  "TX_HISTORY_DESCRIPTION_INDIGO_CA": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> prepaid card redemption",
  ...
  "TX_HISTORY_DESCRIPTION_UKASH_UK": "Buying <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Credits via Ukash",
  "CREDITS_ABTESTING_ZONG": "true",
  "CREDITS_CONFIRM_BRAINTREE_BUTTON_LABEL": "Buy",
  "CREDITS_CASHCARDSG_PRICES_NOTE": "Please note that not all the stores carry <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Scratch Cards of both values, and that the stores could be out of stock. To be sure, call your local store in advance.",
  "CREDITS_LOYALTY_POINTS_TITLE": "Your Loyalty Balance",
  "CREDITS_BRAINTREE_FAILURE_MESSAGE_81715": "Invalid credit card number",
  "INFO_HABBOCLUB_CLUBFURNI": "Once a month, every month, you'll be able to pick an exclusive piece of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Club furni.",
  ...
  "NAVIGATOR_FLATCATEGORY_GLOBAL_REVIEWS": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Reviews",
  ...
  "NAVIGATOR_FLATCATEGORY_GLOBAL_LIFE": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Life",
  "NAVIGATOR_FLATCATEGORY_GLOBAL_GAMES": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Games",
  ...
  "MODERATOR_MSG_MUTE": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> has been muted until {0}.",
  "MODERATOR_MESSAGETEMPLATE_7": "If you need help with a problem  or you know a <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> who does, please visit our safety centre at https://www.habbo.com/playing-habbo/help .",
  ...
  "CFH_REASON_USELESS_TARGET": "Mods looked into the case and found that you have done nothing wrong. Sorry for the inconvenience, have a nice time playing <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>!",
  ...
  "SCAMMING_SEVERESTAFFIMPERSONATION": "Impersonating <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> staff with the intention of scamming is not permitted.",
  "DISRUPTION_FLOODING": "We want everyone to enjoy their time on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. Please keep the screen free from flooding.",
  "CFH_REASON_RECEIVED_REPORTER_SEXUALLY_INAPPROPIATE_BEHAVIOUR": "You have reported a user for sexually inappropiate behaviour. For your own safety, celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> and keep personal information to yourself. Mods will take a look at this in the meantime.",
  ...
  "MODERATOR_MUTEWARNING_2": "Please don't let your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> take part in sexually inappropiate behaviour.",
  "MODERATOR_MUTEWARNING_3": "We want everyone in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> to have fun. Please stay clear from inappropriate or offensive chat.",
  "CFH_REASON_MEETING_IN_REAL_LIFE": "attempting to meet in real life",
  "MODERATOR_MUTEWARNING_4": "We want everyone to enjoy their time on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. Please help us by keeping the game disruption-free.",
  "MODERATOR_MUTEWARNING_5": "Scams are really bad for the whole community and can get your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> in trouble.",
  ...
  "PII_HOMEADDRESS": "Celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. For your safety, it's best to keep personal information such as addresses  to yourself.",
  ...
  "MODERATOR_MSG_GUARDIAN": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Guardians have voted to mute you until {0}",
  ...
  "MODERATOR_MESSAGETEMPLATE_12": "We understand that it's annoying when someone doesn't play fair, but trading and playing other <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>s' games is at your own risk. Please be careful.",
  ...
  "DISRUPTION_COMMERICALSPAM": "Please don't let your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> spoil the fun for others  by spamming commercial advertising.",
  ...
  "MODERATOR_MESSAGETEMPLATE_17": "Unfortunately we can't read chatlogs in this language. Please just ignore the <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> who's annoying you, take them off  your friends list or go to another room.",
  ...
  "TERMSVIOLATION_OWNINGRETROHOTEL": "Clone  <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>s (Retros) can put the original hotel at risk. We suggest you keep it real.",
  "CFH_REASON_CYBERSEX_AUTO": "cybering",
  "TERMSVIOLATION_MINORSACCESSRESTRICTION": "You have to be 13 years or older to play <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. If you are old enough to play <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>, please contact our Help Tool to appeal the ban.",
  ...
  "MODERATOR_MESSAGETEMPLATE_16": "We want you to feel safe and have fun in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. If you find yourself in an uncomfortable situation, clicking the H on the bottom left of your screen is a fast and easy way to get out.",
  ...
  "CFH_REASON_RECEIVED_REPORTER_MEETING_IN_REAL_LIFE": "You have reported a user  for wanting to meet in real life. For your own safety, celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> and stay away from real life meetings. Mods will take a look at this in the meanwhile.",
  "CFH_REASON_RECEIVED_REPORTER_MINORS_ACCESS": "You have reported a user  for being too young to play <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. Thanks for your message. Mods will take a look at this.",
  ...
  "SEXUALLYEXPLICIT_DISCUSSIONOFSEXUALITY": "We want you to feel safe and have fun in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. If you find yourself in an uncomfortable situation or feel that someone is being inappropriate towards you, you can \"mute\" the person by clicking on their avatar and choosing \"Ignore\". Also, clicking the H on the bottom left of your screen is a fast and easy way to get out.",
  "SEXUALLYEXPLICIT_EXPLICITSEXUALTALK": "Please keep your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> out of sexually explicit chat.",
  ...
  "CFH_REASON_MINORS_ACCESS": "being too young to play <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>",
  "SEXUALLYEXPLICIT_SEXLINKS": "Please keep your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> away from offering and/or requesting sexually inappropriate websites.",
  ...
  "CFH_REASON_HELP_ACCOUNT_PAYMENT_ISSUES_AUTOREPLY": "Thanks for your message. Kindly submit a help ticket at <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Customer Service and agents there will be happy to help!",
  "PII_NONSEXUALWEBCAM": "Celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. For your safety, it's best to keep personal information to yourself.",
  ...
  "SEXUALLYEXPLICIT_WEBCAMSEXNAKEDPICS": "Please keep your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> away from offering or requesting sexually inappropriate images.",
  ...
  "CFH_REASON_HELP_AUTO_REPLY": "Thanks for your message. Kindly submit a help ticket at <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Customer Service and agents there will be happy to help!",
  "CFH_REASON_RECEIVED_REPORTER_MEET_IRL": "You have reported a user  for wanting to meet in real life. For your own safety, celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> and stay away from real life meetings. Mods will take a look at this in the meantime.",
  "CFH_REASON_SEXUALLY_INAPPROPIATE_BEHAVIOUR": "sexually inappropiate behaviour",
  "DISRUPTION_BLOCKING": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> is in the way! Blocking spoils the fun for everyone else.",
  "SEXUALLYEXPLICIT_PREDATORYBEHAVIOUR": "Please keep your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> away from sexually inappropriate acts.",
  ...
  "MODERATOR_MSG_KICK": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> was kicked by a moderator.",
  "CFH_REASON_FLOODING": "flooding",
  "CFH_REASON_HELP_HABBO_AUTOREPLY": "Thanks for your message. Kindly submit a help ticket at <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Customer Service and agents there will be happy to help!",
  ...
  "HARASSMENT_HACKINGTHREAT": "You wouldn't want your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> to be hacked. Why threaten to do this to others.?",
  "HARASSMENT_PERSONALTHREATS": "We want everyone on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> to feel safe. Physical or personal threats have no room on here.",
  "CFH_REASON_RESOLVED_REPORTER": "Thanks, mods looked into the issue for you and have taken appropriate action. Have a nice time playing <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>!",
  ...
  "CFH_REASON_RECEIVED_REPORTER_HABBO_NAME": "You have reported a user  for inappropriate <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> name. Thanks for your message. Mods will take a look at this.",
  ...
  "SCAMMING_CASINOSCAM": "We understand that it's annoying when someone doesn't play fair, but trading and playing other <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>s' games is at your own risk. Please be careful.",
  "HARASSMENT_BULLYING": "You wouldn't want your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> to be bullied. Why do it to others?",
  "CFH_CLOSED_RESOLVED": "Thanks, mods looked into the issue for you and have taken appropriate action. Have a nice time playing <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>!",
  ...
  "PII_MAILADDRESSIMCONTACT": "Celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. Celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. For your safety, it's best to keep personal information such as IM and email to yourself.",
  ...
  "DISRUPTION_DOORBLOCKING": "We want everyone to have fun on here, so please move your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> away from the door.",
  ...
  "MODERATOR_MSG_POSTFIX": "Reading through the <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Way and Terms will help you avoid this issue in the future.",
  ...
  "SEXUALLYEXPLICIT_PROSTITUTION": "Please keep your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> out of offering or requesting sexual acts in return for furni.",
  ...
  "INAPPROPRIATENAME_GROUPNAME": "Sorry, but your group name is not quite appropriate for <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>.",
  "MODERATOR_ROOMMESSAGETEMPLATE_1": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> is in the way! Blocking spoils the fun for everyone else.",
  "MODERATOR_ROOMMESSAGETEMPLATE_2": "This room is not appropriate for <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> and will shortly be closed. Anyone remaining will be automatically removed.",
  ...
  "SEXUALLYEXPLICIT_HARASSMENTRAPE": "Please  keep your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> away from harrassing anyone sexually.",
  "CFH_REASON_HATE_SPEECH": "hate speech",
  "CFH_REASON_RECEIVED_REPORTER_HELP_ACCOUNT_PAYMENT_ISSUES": "Thanks for your message. Kindly submit a help ticket at <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Customer Service and agents there will be happy to help!",
  ...
  "PII_PHONENUMBER": "Celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. For your safety, it's best to keep phone numbers to yourself and to not ask anyone for theirs.",
  "SEXUALLYEXPLICIT_MILDSEXUALTALK": "Please keep your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> away from sexually themed chat.",
  ...
  "SCAMMING_MILDSTAFFIMPERSONATION": "Impersonating <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> staff with the intention of scamming is not permitted.",
  ...
  "INAPPROPRIATENAME_ROOMNAME": "Sorry, but your room/event name is not quite appropriate for <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>.",
  "CFH_REASON_RECEIVED_REPORTER_ASKING_PII": "You have reported a user for asking personal information. Celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>! For your safety, it's best to keep personal information to yourself. Mods will take a look at this in the meantime.",
  "HARASSMENT_VIOLENTROLEPLAY": "Please don't let your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> take part in violent role-play.",
  "CFH_REASON_SCAMSITES_PROMOTING": "promoting retros/scamsites",
  "MODERATOR_MSG_BAN": "Your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> has been banned until {0}.",
  ...
  "PII_FULLNAMETOWNSCHOOL": "Celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. For your safety, it's best to keep personal information to yourself.",
  "TERMSVIOLATION_CHILDPORNOGRAPHY": "Offering or requesting illegal website links puts the whole <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> community at risk.",
  "TERMSVIOLATION_SELLINGHABBOACCOUNTFURNI": "The sale or purchase of <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>s accounts can put not only you, but the whole community at risk. And the sale or purchase of items for cash is not permitted either.",
  "CFH_REASON_SWEARING": "insults or offensive language",
  "INAPPROPRIATENAME_HABBONAME": "Sorry, but your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> name is not quite appropriate for <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>.",
  "SEXUALLYEXPLICIT_CYBERSEX": "Please keep your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> away from sexual role-play.",
  "MODERATOR_MSG_TRADINGLOCK": "You have been trade locked until {0}.",
  "PII_SOCIALMEDIACONTACTINFORMATION": "Celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. For your safety, it's best to keep personal information such as social media accounts to yourself.",
  "TERMSVIOLATION_CASINOROOMSLOCAL": "Please don't let your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> place or accept bets. Show of your skills instead of leaving it up to chance!",
  "TERMSVIOLATION_DRUGPROMOTION": "The promotion of illegal activities puts the whole <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> community at risk.",
  ...
  "SCAMMING_STAFFIMPERSONATION": "<?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> staff are unique, just like you. Please don't let your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> impersonate them.",
  ...
  "HARASSMENT_OFFENDINGBEHAVIOUR": "We want everyone in <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> to have fun. Please stay clear from inappropriate or offensive chat.",
  ...
  "MODERATOR_MESSAGETEMPLATE_5": "No call for help needed here. Please just rate your <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> Helper at the end of each help session.",
  "CFH_REASON_RECEIVED_REPORTER_SEXUAL_WEBCAM_IMAGES": "You have reported a user for asking/offering sexual webcam or images. For your own safety, celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?> and keep personal information to yourself. Mods will take a look at this in the meantime.",
  ...
  "MODERATOR_MESSAGETEMPLATE_1": "Celebrate your anonymity on <?= \Illuminate\Support\Facades\Config::get('azure.name'); ?>. For your safety, it's best to keep personal information to yourself.",
