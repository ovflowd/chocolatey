<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse:collapse">
    <tbody>
    <tr>
        <td class="m_-8807198384952369777container"
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="m_-8807198384952369777full"
                   style="border-collapse:collapse;width:100%">
                <tbody>
                <tr>
                    <td align="left" class="m_-8807198384952369777header"
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="m_-8807198384952369777full"
                ...
                <tbody>
                <tr>
                    <td align="left" class="m_-8807198384952369777content"
                        ...
                        <h1 id="m_-8807198384952369777hey-there-shirtclaudio-"
                        ...
                        <p style="color:#000000;font-family:'Ubuntu','Trebuchet MS','Lucida Grande','Lucida Sans Unicode','Lucida Sans',Tahoma,sans-serif;font-size:16px;line-height:1.4;padding:0;margin:0 0 16px 0">
                            A yellow ducky told us that you requested to change your email address of the Habbo account
                            to the email address: {{$mail}}
                        </p>
                        ...
                        <p style="color:#000000;font-family:'Ubuntu','Trebuchet MS','Lucida Grande','Lucida Sans Unicode','Lucida Sans',Tahoma,sans-serif;font-size:16px;line-height:1.4;margin:16px 0 16px 0;padding:0">
                            <a href="{{$url}}"
                               ...
                               target="_blank">Clickhere to securely change your email address</a></p>
                        <p style="color:#000000;font-family:'Ubuntu','Trebuchet MS','Lucida Grande','Lucida Sans Unicode','Lucida Sans',Tahoma,sans-serif;font-size:16px;line-height:1.4;margin:16px 0 16px 0;padding:0">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="m_-8807198384952369777full"
                ...
                <tbody>
                <tr>
                    <td align="center" class="m_-8807198384952369777footer"
