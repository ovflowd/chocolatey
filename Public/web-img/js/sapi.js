...
angular.module("payment.popup", ["config", "google.analytics", "notifier", "popup", "purse.service", "system.data"]).factory("paymentPopup", ["$q", "$translate", "$window", "CONFIG", "SystemData", "googleAnalytics", "notifier", "popup", "purse", function(e, t, o, r, a, n, i, s, l) {
        ...
        return d.getItemName = function(o) {
            ...
            return o.creditAmount ? (o.doubleCredits && r.push("DOUBLE_CREDITS_PREFIX"), t(r, {
                value: o.creditAmount
            }).then(function(e) {
            ...
            function a(o) {
                o.originalEvent.data && o.originalEvent.data.status && (p = o.originalEvent.data.status, "SUCCESS" !== p && "PENDING" !== p || (l.update(), u(t.countryCode), d.getItemName(t).then(function(e) {
                    var r = o.originalEvent.data.txId,
                        a = o.originalEvent.data.currency,
                        i = o.originalEvent.data.priceInCents,
                        s = _(t.categories).sort().join(", "),
            ...
            function m() {
                "SUCCESS" === p && d.getItemName(t).then(function(e) {
                    i.success("SHOP_PAYMENT_SUCCESS", {
                        name: e
                    })
                })
            }
        ...
        return {
            ...
            link: function(t, r, a, n) {
                var i, s = n[0],
                    l = n[1],
                    c = t.$eval(a.habboRemoteData);
        ...
        controller: ["CONFIG", function(e) {
            var t = this,
                o = [e.localizationSite, t.method.localizationKey].join("_");
        ...
        require: {
            PaymentStepsController: "^habboPaymentSteps"
        },
        bindings: {
            item: "<",
            selectedCategory: "@"
        ...
        var o = t.adyenPublicKey,
            r = {},
            a = e.adyen.encrypt.createEncryption(o, r);
        return a
                ...
                return t.get(o).then(function(t) {
                    ...
                    return s.encryptAndSend(e, o, d.method).then(function(e) {
                        if (e.data.success === !0) u.update(), d.transactionId = e.data.transactionId, d.state = "SUCCESS", d.card = {}, c.getItemName(d.item).then(function(e) {
                            l.success("SHOP_PAYMENT_SUCCESS", {
                                name: e
                            })
                        }), c.sendShopTrackingEvents("SUCCESS", d.item.id, d.method.id);
                        else switch (d.state = "FAILURE", e.data.message) {
                            case "LIMIT_EXCEEDED":
        ...
        return t.get = function(t) {
            try {
                ...
                return Bugsnag.notifyException(r, "LocalStorage not supported", {
                    groupingHash: "LocalStorage"
                }, "info"), null
            }
        }, t.set = function(t, o) {
            try {
                ...
                Bugsnag.notifyException(r, "LocalStorage not supported", {
                    groupingHash: "LocalStorage"
                }, "info")
            }
        }, t
        ...
        return {
            shortCache: e.createCache("shortHttpCache"),
            longCache: e.createCache("longHttpCache", {
                maxAge: 36e5
            })
        }
        ...
        controllerAs: "UserMenuController",
        templateUrl: "common/header/user-menu/user-menu.html"
    ...
    }), angular.module("hotel.button", ["locale", "templates"]).component("habboHotelButton", {
        templateUrl: "common/header/hotel-button/hotel-button.html"
    }), angular.module("header.ad", ["ad.unit", "templates"]).component("habboHeaderAd", {
        controller: ["$scope", "$location", function(e, t) {
            ...
            var a = ["/playing-habbo/help", "/registration", "/reset-password", "/settings", "/shop"],
                n = this;
            o(), e.$on("$stateChangeSuccess", o)
        }],
        controllerAs: "HeaderAdController",
        templateUrl: "common/header/header-ad/header-ad.html"
        ...
        return {
            ...
            link: function(e, t, o) {
                ...
                t.after(angular.element("<i/>", {
                    "class": "password-toggle-mask__icon",
                    click: r,
        ...
        transclude: !0
    }), angular.module("captcha", ["config", "locale", "noCAPTCHA", "templates"]).constant("CAPTCHA_EVENTS", {
        reset: "captcha-reset"
    }).component("habboCaptcha", {
        require: {
            FormController: "^form"
        },
        bindings: {
        ...
        controllerAs: "VoucherIconController",
        templateUrl: "shop/voucher-redeem/voucher-icon/voucher-icon.html"
        ...
        templateUrl: "shop/store/inventory/products.html"
        ...
        templateUrl: "shop/store/inventory/credits.html"
        ...
        controller: ["$location", function(e) {
            ...
            t.isActive = function(e) {
                ...
                t.selectedCategory = "all" === o ? null : o, t.selectedCategory !== r && e.search(_.extend(e.search(), {
                    category: t.selectedCategory
                }))
            }
        }],
        controllerAs: "CategoryFilterController",
        templateUrl: "shop/store/category-filter/category-filter.html"
        ...
        return o.open = function() {
            return t = e.open({
                templateUrl: "settings/account-security/safety-questions/safety-questions-modal.html"
            }), t.result
        }, o
        ...
        return {
            ...
            questionKey: "IDENTITY_SAFETYQUESTION_" + e
        }
        ...
        controllerAs: "FacebookConnectController",
        templateUrl: "security/login/facebook-connect/facebook-connect.html"
        ...
        return t.open = function() {
            return e.open({
                size: "sm",
                templateUrl: "security/login/claim-password/claim-password-modal.html"
            }).result
        }, t
        ...
        controllerAs: "ForceTosFormController",
        templateUrl: "security/force/force-tos/force-tos-form.html"
        ...
        return o.open = function(o) {
            return e.open({
                ...
                resolve: {
                    emailAddress: _.constant(o.email)
                }
        ...
        controller: ["$scope", "force", "notifier", function(e, t, o) {
            ...
            r.saveInProgress = !1, r.save = function() {
                e.forceEmailChangeForm.$valid && (r.saveInProgress = !0, t.changeEmail(r.emailAddress).then(function(e) {
                    r.onSuccess({
                        email: e.email
                    }), o.success("EMAIL_FORCE_CHANGE_SUCCESS")
                })["catch"](function(t) {
                    var r = t.data && t.data.error;
        ...
        controllerAs: "ForceEmailFormController",
        templateUrl: "security/force/force-email/force-email-form.html"
    }), angular.module("room.icon", ["remove.on.error", "show.on.load", "templates"]).component("habboRoomIcon", {
        bindings: {
            url: "@"
        },
        controllerAs: "RoomIconController",
        templateUrl: "profile/item-lists/room-icon/room-icon.html"
        ...
        controllerAs: "ReportFormController",
        templateUrl: "profile/creation/report/report-form.html"
        ...
        return n.started = !1, n.loaded = !1, n.start = function(s) {
            ...
            function d(e) {
                var t = _.upperFirst(e.name),
                    o = e.remaining || 0,
                    r = e.duration ? 1e3 * (e.duration - o) : null;
            ...
            function h(e) {
                n.started = !1, n.loaded = !1, t.cancel(g), angular.element(o).off("message", l), f && f(), "midroll" === s && r.handle({
                    interstitial: e
                })
            }
            var f, b = {
        ...
        controllerAs: "InterstitialController",
        templateUrl: "hotel/client/interstitial/interstitial.html"
        ...
        controllerAs: "ClientErrorController",
        templateUrl: "hotel/client/client-error/client-error.html"
    }), angular.module("client.closed", ["hotel.closed", "templates"]).component("habboClientClosed", {
        templateUrl: "hotel/client/client-closed/client-closed.html"
    }), angular.module("client.close.expander", ["client.close.expand", "events"]).directive("habboClientCloseExpander", ["$timeout", "EVENTS", function(e, t) {
        return {
            restrict: "A",
            link: function(o, r) {
                function a() {
        ...
        return {
            ...
            link: function(t, o) {
                ...
                function i(t, r) {
                    s && e.cancel(s), l = r, s = e.animate(o, {
                        width: t
                    }, {
                        width: r
                    })
        ...
        controller: function() {
            ...
            e.open = !1, e.tabs = [], e.activeTab = null, e.setTab = function(t) {
                ...
                e.open = !1, e.activeTab = _.find(e.tabs, {
                    path: t
                })
            }
        },
        ...
        return {
            ...
            link: function(t, o) {
                function r() {
                    var t = e.pageYOffset > 0 ? e.pageYOffset : 0,
                        r = i - t;
        ...
        controller: ["$location", "CONFIG", "Head", "googleAnalytics", "popup", function(e, t, o, r, a) {
            ...
            n.shareOnFacebook = function() {
                var t = $.param({
                    ...
                    o = "http://www.facebook.com/sharer.php?" + t;
        ...
        controllerAs: "SocialShareController",
        templateUrl: "common/social-share/social-share.html"
    ...
    }), angular.module("official.room.avatar", ["locale", "templates"]).component("officialRoomAvatar", {
        templateUrl: "common/official-room-avatar/official-room-avatar.html"
    }), angular.module("notifier", ["locale"]).factory("notifier", ["$q", "$translate", function(e, t) {
        var o = {
                extendedTimeOut: 1e3,
                hideDuration: 300,
            ...
            a = _.partialRight(toastr.success, "", o),
            n = _.partialRight(toastr.error, "", o),
            i = _.partialRight(toastr.error, r),
            s = function(e) {
                return function(o, r) {
                ...
                return function(r, a, n) {
                    e.all([t(a, n), t(r), t("OK_BUTTON")]).then(function(e) {
                        ...
                        t.delegate("button", "click", function() {
                            toastr.options.hideDuration = 0, toastr.clear(t, {
                                force: !0
                            })
                        })
                    })
        ...
        var r = {},
            a = "ef2356a4926bf225eb86c75c52309c32";
        ...
        controllerAs: "ImagerController",
        templateUrl: "common/imager/imager.html"
    }), angular.module("hotel.closed", ["locale", "templates"]).component("habboHotelClosed", {
        templateUrl: "common/hotel-closed/hotel-closed.html"
    }), angular.module("header", ["header.ad", "locale", "navigation", "security", "sticky.header", "templates", "user.menu"]).component("habboHeaderLarge", {
        bindings: {
            active: "@"
        },
        ...
        controller: ["loginModal", function(e) {
            var t = this;
            t.openLoginModal = e.open
        }],
        controllerAs: "HeaderSmallController",
        templateUrl: "common/header/header-small.html",
        transclude: !0
        ...
        controller: ["CONFIG", function(e) {
            var t = this;
            t.imagingUrl = e.hotelUrl + "/habbo-imaging/badge/"
        }],
        controllerAs: "GroupBadgeController",
        templateUrl: "common/group-badge/group-badge.html"
    }), angular.module("google.analytics", []).factory("googleAnalytics", ["$window", function(e) {
        function t(t) {
            e.Bugsnag && e.Bugsnag.notifyException(t, "GA not supported", {
                groupingHash: "GA"
            }, "info")
        }
        var o = {};
    ...
    }]), angular.module("form", ["captcha", "email.address", "password.current", "password.new", "password.toggle.mask", "search", "validators"]), angular.module("footer", ["locale", "templates", "zendesk.url"]).constant("FOOTER_LINKS", ["FOOTER_SUPPORT", "FOOTER_SAFETY", "FOOTER_PARENTS", "FOOTER_TOS_AND_PRIVACY", "FOOTER_ADVERTISERS"]).component("habboFooter", {
        ...
        controller: ["SystemData", "localStorage", function(e, t) {
            var o = this;
            o.show = !1, t.get("acceptCookies") || ("eu" === e.geoLocation.continent ? o.show = !0 : t.set("acceptCookies", !0)), o.close = function() {
                o.show = !1, t.set("acceptCookies", !0)
            }
        }],
        controllerAs: "EuCookieBannerController",
        templateUrl: "common/eu-cookie-banner/eu-cookie-banner.html"
        ...
        var e = {};
        return e.HEADER = ["                                                                        ,,,   ", "  ,,,,,,,,,,,,,,, ,,,,,,,,,,,,,,,,,,,,,,, ,,,,,,,,,,,,    ,,,,,,,,,,   ,::,,  ", ",,@@@@@@@@@@@@@@:,:@@@@@@@@::@@@@@@@@@@@::@@@@@@@@@@@@:,,,:@@@@@@@@:,,,::: :, ", ",,@@@@@@@@@@@@@@@:@@@@@@@@@@:@@@@@@@@@@@@@@@@@@@@@@@@@@:,:@@@@@@@@@@:,:   : ,,", ",,@@,,,,,@,,,,,,@@,,,,,,,,,,@@,,,,,,,,,,,@@@,,,,,,,,,,@@@@,,,,,,,,,,@@:  :: ,,", ",,@@,,,,,@,,,,,,@@,,,,,,,,,,@@,,,,,,,,,,,,@@,,,,,,,,,,,@@@,,,,,,,,,,@@:::: :,,", ",,@@,,,,,@,,,,,,@,,,,,,,,,,,,@,,,,,,,,,,,,@@,,,,,,,,,,,,@,,,,,,,,,,,,@@@::,,, ", ",,@@,,,,,@,,,,,,@,,,,,,,,,,,,@,,,,,,,,,,,,@@,,,,,,,,,,,,@,,,,,,,,,,,,@@@:,,,  ", ",,@@,,,,,@,,,,,,@,,,,,@@,,,,,@,,,,,,@,,,,,@@,,,,,@,,,,,,@,,,,,@@,,,,,@;;@@,,  ", ",,@@,,,,,@,,,,,,@,,,,,@@,,,,,@,,,,,,@,,,,,@@,,,,,@,,,,,,@,,,,,@@,,,,,@;;@@:,  ", ",,@@,,,,,,,,,,,,@,,,,,@@,,,,,@,,,,,,@,,,,,@@,,,,,@,,,,,,@,,,,,@@,,,,,@;;;;@:, ", ",,@@,,,,,,,,,,,,@,,,,,@@,,,,,@,,,,,,,,,,,,@@,,,,,,,,,,,,@,,,,,@@,,,,,@;;;;@@,,", ",,@@,,,,,,,,,,,,@,,,,,@@,,,,,@,,,,,,,,,,@@@@,,,,,,,,,,@@@,,,,,@@,,,,,@;;;;@@,,", ",,@@::::::::::::@:::::@@:::::@::::::::::@@@@::::::::::@@@:::::@@:::::@;;;;@@,,", ",,@@::::::::::::@::::::::::::@::::::::::::@@::::::::::::@:::::@@:::::@;;;;@@,,", ",,@@::::::::::::@::::::::::::@::::::@:::::@@:::::@::::::@:::::@@:::::@;;;;@@,,", ",,@@:::::@::::::@::::::::::::@::::::@:::::@@:::::@::::::@:::::@@:::::@;;;;@@,,", ",,@@:::::@::::::@:::::@@:::::@::::::@:::::@@:::::@::::::@:::::@@:::::@;;;;@@,,", ",,@@:::::@::::::@:::::@@:::::@::::::::::::@@::::::::::::@::::::::::::@;;;;@@,,", ",,@@:::::@::::::@:::::@@:::::@::::::::::::@@::::::::::::@::::::::::::@;;;;@@,,", ",,@@:::::@::::::@:::::@@:::::@::::::::::::@@:::::::::::@@@::::::::::@@;;;;@@,,", ",,@@:::::@::::::@:::::@@:::::@:::::::::::@@@::::::::::@@@@::::::::::@@;;;;@@,,", ",,@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@;;;@@@@@@@@@@;;;;;;@@,,", ",,@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@;;@@@@@@@@@@@;;;;;@@@@@@@@@;;;;;;;@@,,", ",,,:@@;;;;@@;;;;;@@;;;;;@@;;;;@@;;;;;;;;;;;;@@;;;;;;;;;;;;;;@@;;;;;;;;;;;;@@,,", " ,,,@@;;;;;@@;;;;;@@;;;;@@;;;;;@@;;;;;;;;;;;@@;;;;;;;;;;;;;;@@;;;;;;;;;;;;@:,,", "  ,,,:@@;;;;@@;;;;;@@;;;;;@@;;;;@@;;;;;;;;;;@@@@;;;;;;;;;;@@@:@@;;;;;;;;@@:,, ", "   ,,,@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@:,@@@@@@@@@@@@,,, ", "    ,,,:::::::::::::::::::::::::::::::::::::::,::::::::::::,,,,,::::::::,,,,  ", "     ,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,   ", "      ,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,   ,,,,,,,,,,     ", "                                                                              ", "                                                                              "],
            e.FOOTER = ["                                                                              ", "                                                                   - Habbo Dev"], e.format = function(t) {
                var o = [],
                    r = "";
        ...
        templateUrl: "common/avatar/avatar.html"
        ...
        require: {
            AccordionGridController: "^habboAccordionGrid"
        },
        ...
        controllerAs: "HabboAccordionGridController",
        ...
        return {
            get: function(o, r) {
                var a = r.replace(/-/g, "_"),
                    n = t.habboWebNewsUrl + "articles/" + o + "_" + a + ".html";
        ...
        return function(r) {
            return e.post(t.shopUrl + "/voucher/redeem", {
                voucherCode: r
            }).then(function(e) {
        ...
        controller: ["$compile", "$scope", "$timeout", "$translate", "EVENTS", "notifier", "purse", "voucherRedeem", function(e, t, o, r, a, n, i, s) {
            ...
            d.redeemInProgress = !1, d.redeem = function() {
                t.voucherRedeemForm.$valid && (d.redeemInProgress = !0, s(d.voucherCode).then(function(e) {
                    return l(), i.update(), c(e)
                })["catch"](function(e) {
        ...
        controllerAs: "VoucherRedeemController",
        templateUrl: "shop/voucher-redeem/voucher-redeem.html"
        ...
        e.statePrivate("shop.subscriptions", {
            ...
            parent: "shop",
            data: {
                title: "HEAD_TITLE_SHOP_SUBSCRIPTIONS"
            },
    ...
    }]), angular.module("shop.footer", ["locale", "templates", "zendesk.url"]).component("habboShopFooter", {
        templateUrl: "shop/shop-footer/shop-footer.html"
    }), angular.module("shop.countries", ["locale", "templates"]).component("habboShopCountries", {
        bindings: {
            country: "<",
            countries: "<"
        },
        controller: ["$scope", "$location", function(e, t) {
            e.$watch("ShopCountriesController.country", function(e, o) {
                var r = e && e.countryCode || null,
                    a = o && o.countryCode || null;
                r && r !== a && t.search({
                    country: r
                })
            })
        }],
        controllerAs: "ShopCountriesController",
        templateUrl: "shop/shop-countries/shop-countries.html"
        ...
        controllerAs: "PurseController",
        templateUrl: "shop/purse/purse.html"
        ...
        e.statePrivate("shop.earnCredits", {
            ...
            data: {
                title: "HEAD_TITLE_SHOP_EARN_CREDITS"
            },
            parent: "shop",
            resolve: {
        ...
        templateUrl: "shop/credit-title/credit-title.html"
        ...
        controllerAs: "CreditIconController",
        templateUrl: "shop/credit-icon/credit-icon.html"
        ...
        return e(t.apiUrl + "/user/preferences", {}, {
            ...
            save: {
                method: "POST",
                url: t.apiUrl + "/user/preferences/save"
            }
        })
        ...
        controllerAs: "PasswordChangeFormController",
        templateUrl: "settings/password-change/password-change-form.html"
        ...
        controllerAs: "EmailChangeFormController",
        templateUrl: "settings/email-change/email-change-form.html"
        ...
        return n.query = function() {
            ...
            return e.post(o.apiUrl + "/user/avatars", {
                name: t
            }).then(function(e) {
        ...
        e.statePrivate("settings.avatar", {
            ...
            data: {
                title: "HEAD_TITLE_AVATAR_SELECTION"
            },
            resolve: {
    ...
    }]), angular.module("security.session", ["security.require.habbo.account.session", "security.require.non.staff.account.session", "security.require.session", "security.session.service"]), angular.module("security.session.store", []).factory("SessionStore", ["$window", function(e) {
        var t = {};
        return t.create = function(t) {
            try {
                e.sessionStorage.setItem("session", angular.toJson(t))
            } catch (o) {
                Bugsnag.notifyException(o, "SessionStorage not supported", {
                    groupingHash: "SessionStorage"
                }, "info")
            }
        }, t.get = function() {
            try {
                ...
                return Bugsnag.notifyException(o, "SessionStorage not supported", {
                    groupingHash: "SessionStorage"
                }, "info"), null
            }
        }, t.destroy = function() {
            try {
                ...
                Bugsnag.notifyException(t, "SessionStorage not supported", {
                    groupingHash: "SessionStorage"
                }, "info")
            }
        }, t
        ...
        var o = {};
        return o.create = function(o) {
            e.Bugsnag && (e.Bugsnag.user = {
                id: t.createHash(o.identityId.toString())
            })
        }, o
        ...
        return {
            ...
            link: function(o) {
                o.answers = {
                    trust: !1
                }, o.unlockingInProgress = !1, o.isTrustedLocationEnabled = !0, o.unlock = function() {
                    o.safetyLockForm.$valid && (o.unlockingInProgress = !0, t.unlock(o.answers).then(o.onUnlock)["catch"](function(t) {
                        var r = t.status;
                        409 === r ? o.$broadcast("remote-data-invalid", "answer") : 429 === r ? e.error("ERROR_TOO_MANY_ATTEMPTS", {
                            time: moment(t.data.nextValidRequestDate).fromNow(!0)
        ...
        return t.open = function(t, o, r) {
            return e.open({
                ...
                resolve: {
                    questions: _.constant(t),
                    data: _.constant(o),
                    targetAction: _.constant(r)
                },
        ...
        return {
            ...
            link: function(t) {
                t.answers = {}, t.unlockingInProgress = !1, t.isTrustedLocationEnabled = !1, t.unlock = function() {
                    t.safetyLockForm.$valid && (t.unlockingInProgress = !0, _.assign(t.data, t.answers), t.targetAction({
                        data: t.data
                    }).then(t.onSuccess)["catch"](function(o) {
                        var r = o.status;
                        409 === r ? t.$broadcast("remote-data-invalid", "answer") : 429 === r ? e.error("ERROR_TOO_MANY_ATTEMPTS", {
                            time: moment(o.data.nextValidRequestDate).fromNow(!0)
                        }) : e.error("ERROR_SERVER")
                    })["finally"](function() {
    ...
    }]), angular.module("security.rpx", ["security.rpx.message", "security.rpx.service"]), angular.module("security.login.shake", []).constant("LOGIN_EVENTS", {
        invalidCredentials: "login-invalid-credentials"
    }).directive("habboShake", ["LOGIN_EVENTS", function(e) {
        return {
            restrict: "A",
            link: function(t, o) {
                t.$on(e.invalidCredentials, function() {
                    var e = angular.element(".modal-dialog"),
                        t = e.is(":visible") ? e : o;
        ...
        return o.open = function() {
            return t = e.open({
                templateUrl: "security/login/login-modal.html"
            }), t.result
        }, o.isOpen = function() {
        ...
        controller: ["$element", "$location", "$scope", "$window", "LOGIN_EVENTS", "captchaModal", "notifier", "recoverPasswordModal", "security", function(e, t, o, r, a, n, i, s, l) {
            ...
            function d(e) {
                var t = e.status,
                    o = e.data && e.data.message;
                h = Boolean(e.data && e.data.captcha), 401 === t ? "login.staff_login_not_allowed" === o ? i.error("ERROR_LOGIN_STAFF_NOT_ALLOWED") : "invalid-captcha" === o ? c() : m() : 429 === t ? i.error("ERROR_TOO_MANY_ATTEMPTS", {
                    time: moment(e.data.nextValidRequestDate).fromNow(!0)
        ...
        return r.changeEmail = function(r) {
            return e.post(t.apiUrl + "/force/email-change", {
                newEmail: r
            }).then(function(e) {
                return o.trackEvent("Email", "Forced change"), e.data
            })
        }, r.changePassword = function(r) {
            return e.post(t.apiUrl + "/force/password-change", {
                newPassword: r
            }).then(function(e) {
        ...
        title: "Habbo",
        description: "Faça o seu check-in no maior Hotel virtual do mundo DE GRAÇA! Você poderá fazer novos amigos, jogar e criar seus próprios jogos, bater papo, construir seus quartos e muito mais!",
        image: "https://habboo-a.akamaihd.net/habbo-web/america/pt/assets/images/app_summary_image-1200x628.85a9f5dc.png",
        imageHeight: 628,
        imageWidth: 1200,
        ...
        var n, i = ["login.user_banned", "login.identity_banned", "login.avatar_banned", "user.identity_banned", "user.avatar_banned"],
            s = {};
            ...
            if ("banned" === n.error) {
                ...
                return e.all([t(s), t(i), t(l)]).then(function(e) {
                    var t = e[0],
                        i = e[1],
                        s = e[2],
                        l = -1 === t.indexOf("%") ? t : t.substring(0, t.indexOf("%")),
                        c = n.reason;
        ...
        controller: ["$window", function(e) {
            var t = this,
                o = e.btoa(t.room.name.replace(/[^\x00-\x7F]/g, "").trim());
        ...
        controller: ["$scope", "daysInMonthFilter", function(e, t) {
            var o = 7,
                r = 1900,
                a = (new Date).getFullYear() - o,
                n = this;
            n.days = _.range(1, 32), n.months = [{
                value: 1,
                translationKey: "MONTH_JANUARY"
            }, {
                value: 2,
                translationKey: "MONTH_FEBRUARY"
            }, {
                value: 3,
                translationKey: "MONTH_MARCH"
            }, {
                value: 4,
                translationKey: "MONTH_APRIL"
            }, {
                value: 5,
                translationKey: "MONTH_MAY"
            }, {
                value: 6,
                translationKey: "MONTH_JUNE"
            }, {
                value: 7,
                translationKey: "MONTH_JULY"
            }, {
                value: 8,
                translationKey: "MONTH_AUGUST"
            }, {
                value: 9,
                translationKey: "MONTH_SEPTEMBER"
            }, {
                value: 10,
                translationKey: "MONTH_OCTOBER"
            }, {
                value: 11,
        ...
        controller: ["$uibModal", function(e) {
            ...
            t.openModal = function() {
                e.open({
                    ...
                    resolve: {
                        items: _.constant(t.items),
                        type: _.constant(t.type)
                    }
                })
            }
        }],
        ...
        controllerAs: "BadgeListController",
        templateUrl: "profile/item-lists/badges.html"
        ...
        e.statePublic("photo", {
            ...
            onEnter: ["creations", "index", "Head", function(e, t, o) {
                o.setTitle("HEAD_TITLE_PHOTO", {
                    name: e[t].creator_name
                }), o.image = e[t].url, o.imageHeight = e[t].contentHeight, o.imageWidth = e[t].contentWidth
            }],
            resolve: {
            ...
            onEnter: ["creations", "index", "Head", function(e, t, o) {
                var r = e[t];
                "SELFIE" === r.type ? o.setTitle("HEAD_TITLE_SELFIE", {
                    name: r.creator_name
                }) : o.setTitle("HEAD_TITLE_CREATION", {
                    creation: r.title,
                    name: r.creator_name
        ...
        controllerAs: "CreationContentController",
        templateUrl: "profile/creation/creation-content.html"
        ...
        function o(e) {
            a.postMessage({
                call: "interstitial-status",
                target: e.interstitial
            }, "*")
        }
        var r = {},
            a = null,
        ...
        return r.init = function(e) {
            ...
            var t = _(e).pickBy(_.isString).keys().head(),
                o = n[t];
            o && o(e)
        }, r
        ...
        templateUrl: "hotel/client/client.html"
    ...
    }]), angular.module("register.banner", ["air.download.link", "local.register.banner", "locale", "templates"]).component("habboRegisterBanner", {
        templateUrl: "home/register-banner/register-banner.html"
    }), angular.module("promos.service", ["config"]).factory("promos", ["$http", "$q", "CONFIG", function(e, t, o) {
        return {
            get: function() {
        ...
        e.statePublic("reportUnauthorized", {
            ...
            data: {
                title: "HEAD_TITLE_EMAIL_REPORT_UNAUTHORIZED"
            },
        ...
        e.statePublic("community.rooms", {
            ...
            data: {
                title: "HEAD_TITLE_ROOMS"
            },
            resolve: {
                rooms: ["Leaderboard", "CONFIG", function(e, t) {
                    return e.get({
                        site: t.hotel,
                        leaderboard: "visited-rooms",
                        timeframe: "daily",
                        date: "latest"
                    }).$promise
                }]
        ...
        return {
            get: function(o, r) {
                var a = o.replace(/-/g, "_"),
                    n = t.habboWebNewsUrl + a + "_" + r + ".html";
                return e.get(n).then(function(e) {
                    return {
            ...
            resolve: {
                category: ["$location", "$q", "$stateParams", "category", function(e, t, o, r) {
                    ...
                    return r.get(o.category + a, o.page)["catch"](function(r) {
                        return 0 !== a.length || "1" !== o.page && "last" !== o.page ? a.length > 0 && "1" === o.page ? (e.path("/community/category").replace(), t.when({})) : t.reject(r) : (e.path("/community/category/" + o.category + "/archive/1").replace(),
                            t.when({}))
                    })
                }]
            },
        ...
        function n(e) {
            return e = e || [], 1 === e.length ? [] : (e.unshift("all"), _.map(e, function(e) {
                return {
                    key: e,
                    translateKey: "SHOP_PAYMENT_METHOD_" + e.toUpperCase()
                }
            }))
        }
        ...
        return i.inventory = function() {
            return arguments[0] = arguments[0] || {}, _.extend(arguments[0], {
                "public": o.hasSession() ? null : "public"
        ...
        return a.login = function() {
            return t.isSdkLoaded() ? o()["catch"](r) : e.reject({
                data: {
                    message: "fb.sdk_not_loaded"
                }
            })
        }, a
        ...
        var a = /<title>Client Validation<\/title>/gi,
            n = {};
        ...
        return e(t.apiUrl + "/public/rooms/:id", null, {
            get: {
                method: "GET",
                cache: o.shortCache
            }
        ...
        return s.register = function(s) {
            return a.register(s.birthdate), a.isLocked() ? t.reject({
                data: {
                    error: "age"
                }
            }) : e.post(r.apiUrl + "/public/registration/new", s).then(function(e) {
                var r = t.defer();
        ...
        controller: ["$scope", "$state", "$stateParams", "CAPTCHA_EVENTS", "CONFIG", "SystemData", "googleAnalytics", "notifier", "registration", function(e, t, o, r, a, n, i, s, l) {
            ...
            var u = this;
            u.hasCaptchaToken = Boolean(o.captchaToken), u.registration = {
                captchaToken: o.captchaToken
            }, u.registerInProgress = !1, u.showPartnerRegistration = n.isIDCGamesCountry() || c(), u.register = function() {
                ...
                i.trackEvent("Registration", "Clicked", o), e.registrationForm.$valid && (u.registerInProgress = !0, l.register(u.registration).then(function(e) {
                    ...
                    var o = t.data && t.data.error;
                    "age" === o ? s.error("ERROR_BIRTHDATE_AGE") : ("registration_email" === o || "registration.error.invalid_email" === o ? e.$broadcast("remote-data-invalid", "emailInvalid") : "registration_email_in_use" === o ? e.$broadcast("remote-data-invalid", "emailUsedInRegistration") : 429 === t.status ? s.error("ERROR_TOO_MANY_ATTEMPTS", {
                        time: moment(t.data.nextValidRequestDate).fromNow(!0)
                    }) : s.error("ERROR_SERVER"), e.$broadcast(r.reset))
                })["finally"](function() {
        ...
        controllerAs: "RegistrationFormController",
        templateUrl: "registration/registration-form.html"
        ...
        var a = this;
        a.profile = r, o.hasSession() && r.uniqueId === o.user.uniqueId ? a.items = t["private"]() : r.profileVisible && (a.items = t.items({
            uniqueId: r.uniqueId
        })), a.stories = e.stories({
            uniqueId: r.uniqueId
        }), a.photos = e.photos({
        ...
        return r.send = function(r) {
            return e.post(t.apiUrl + "/public/forgotPassword/send", {
                email: r
            }).then(function(e) {
        ...
        e.statePublic("resetPassword", {
            ...
            data: {
                title: "HEAD_TITLE_PASSWORD_RESET"
            },
    ...
    }]), angular.module("home", ["header", "locale", "messaging", "news", "register.banner", "router", "tabs", "templates"]).config(["$stateProvider", "$urlRouterProvider", function(e, t) {
        e.statePublic("home", {
            url: "?captchaToken",
            "abstract": !0,
        ...
        return function(a) {
            return e.post(t.apiUrl + "/public/registration/activate", {
                token: a
            }).then(function(e) {
    ...
    function() {
        ...
        window.Bugsnag || (window.Bugsnag = {
            ...
            var t = e.resourceUrlWhitelist(),
                o = "https://*.Habbo.com/**,https://*.Habbo.top/**,http://*.Habbo.com/**,http://*.Habbo.top/**".split(",");
            ...
            badgeUrl: window.badgeurl,
			hotelUrl: window.hotelurl,
            googlePlayUrl: "https://play.google.com/store/apps/details?id=air.com.sulake.habboair",
            habboWebAdsUrl: "https://habboo-a.akamaihd.net/habbo-web-ads/",
            habboWebLeaderboardsUrl: window.hotelurl + "/api/public/leader/",
			habboWebNewsUrl: "/api/public/promos/",
			habboWebPagesUrl: "/layout/",
            imagingUrl: window.imagingurl,
			lang: window.hotelang,
            lang: window.hotelang,
			hotel: "hhus",
			localizationSite: "br",
			minAge: parseInt("13", 10),
			rpxLocale: "pt-BR",
			rpxTokenUrl: "https://www.habbo.com.br/api/public/authentication/rpx",
			sponsorPayAppId: "1291",
			sponsorPayLocale: "pt",
			...
			e.changeLocale("en-us")
		}]), angular.module("noCAPTCHA").config(["noCAPTCHAProvider", function (e) {
			e.setLanguage("en-US"), e.setSiteKey("6LetihIUAAAAAAuV-Fz6gZWVAqj_u63-wJG0mku5")
		}]), angular.module("pascalprecht.translate").config(["$translateProvider", function (e) {
			e.preferredLanguage(window.hotelang), e.useStaticFilesLoader({
				prefix: "/web-img/lang/",
				suffix: ".json"
