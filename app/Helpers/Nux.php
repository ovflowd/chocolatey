...
final class Nux
{
    ...
    {
        $room = (new Room)->store("{$user->name}'s room'", "{$user->name} has entered the building", 'model_h', 25, 12, 610, 2403);
        $room->save();
    ...
    {
        $room = (new Room)->store("{$user->name}'s room'", "{$user->name} has entered the building", 'model_h', 25, 12, 307, 3104, 1.10);
        $room->save();
        ...
        DB::table('items')->insert(
            ...
            ['room_id' => $room->id, 'item_id' => 17016, 'x' => 3, 'y' => 11, 'z' => 0.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17016, 'x' => 4, 'y' => 9, 'z' => 0.00000, 'rot' => 4, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17090, 'x' => 3, 'y' => 9, 'z' => 0.00000, 'rot' => 2, 'extra_data' => '1'],
            ['room_id' => $room->id, 'item_id' => 17176, 'x' => 3, 'y' => 9, 'z' => 0.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17176, 'x' => 3, 'y' => 9, 'z' => 0.40000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17176, 'x' => 3, 'y' => 10, 'z' => 0.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17190, 'x' => 3, 'y' => 11, 'z' => 0.00000, 'rot' => 2, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17190, 'x' => 4, 'y' => 9, 'z' => 0.00000, 'rot' => 4, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17191, 'x' => 3, 'y' => 10, 'z' => 0.40000, 'rot' => 2, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17191, 'x' => 3, 'y' => 12, 'z' => 0.00000, 'rot' => 2, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17484, 'x' => 8, 'y' => 3, 'z' => 1.00000, 'rot' => 0, 'extra_data' => '0'],
            ['room_id' => $room->id, 'item_id' => 17499, 'x' => 7, 'y' => 3, 'z' => 1.00000, 'rot' => 2, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 7, 'y' => 2, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 7, 'y' => 4, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 7, 'y' => 5, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 8, 'y' => 2, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 8, 'y' => 5, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 9, 'y' => 2, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 9, 'y' => 5, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 10, 'y' => 2, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 10, 'y' => 3, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 10, 'y' => 4, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17520, 'x' => 10, 'y' => 5, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 17987, 'x' => 5, 'y' => 11, 'z' => 0.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 18051, 'x' => 5, 'y' => 2, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 18051, 'x' => 5, 'y' => 4, 'z' => 1.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 18051, 'x' => 8, 'y' => 9, 'z' => 0.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 18051, 'x' => 8, 'y' => 11, 'z' => 0.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 18051, 'x' => 9, 'y' => 9, 'z' => 0.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 18051, 'x' => 9, 'y' => 11, 'z' => 0.00000, 'rot' => 0, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 18061, 'x' => 8, 'y' => 8, 'z' => 0.00000, 'rot' => 2, 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 18061, 'x' => 8, 'y' => 9, 'z' => 0.00000, 'rot' => 6, 'extra_data' => '1'],
            ['room_id' => $room->id, 'item_id' => 18061, 'x' => 10, 'y' => 8, 'z' => 0.00000, 'rot' => 4, 'extra_data' => '1'],
        ...
        DB::table('items')->insert(
            ...
            ['room_id' => $room->id, 'item_id' => 23063, 'wall_pos' => ':w=2,11 l=6,58 l', 'extra_data' => ''],
            ['room_id' => $room->id, 'item_id' => 23078, 'wall_pos' => ':w=6,1 l=0,26 r', 'extra_data' => '1'],
            ['room_id' => $room->id, 'item_id' => 23078, 'wall_pos' => ':w=7,1 l=4,28 r', 'extra_data' => '3'],
            ['room_id' => $room->id, 'item_id' => 23078, 'wall_pos' => ':w=8,1 l=13,33 r', 'extra_data' => '1'],
