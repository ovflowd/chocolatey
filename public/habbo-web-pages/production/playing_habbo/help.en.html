<h1>How to deal with a problem in Habbo</h1>
<p>You may occasionally come across the odd misbehaving Habbo. Never fear, help is at hand! On this page we&apos;ll tell
    you what tools work best in tricky situations.</p>
<h2>In a room</h2>
<p>When you&apos;re in a room and another Habbo is being out-of-line, click on their avatar and a drop-down menu will
    appear. This lets you either ignore, moderate or in really disruptive cases, report them.</p>
<h4>Ignoring a Habbo</h4>
<p>If <strong>a Habbo is saying things which make you feel uncomfortable</strong>, you can put them on ignore. This is
...
<ol>
    ...
    <li>You won&apos;t see what the Habbo says anymore. If you want to un-ignore later, click the avatar again and
        choose <em>Listen</em>.
    </li>
</ol>
<h4>Moderating a Habbo</h4>
<p><strong>In your own rooms, or if you have room rights</strong>, you can decide who can visit the room, and you have
    the power to mute, kick or ban other users. This allows you to play an active part in the general Habbo moderation
    and to contribute to a safer and more enjoyable community.</p>
<p>Read more on Habbo Helpdesk about <a target="_blank"
    ...
    settings</a>.</p>
<h4>Reporting a Habbo</h4>
<p>If <strong>things are getting heated in a room</strong>: Habbos are talking about meeting in real life, want to video
    ...
    or themselves.</p>
<ol>
    <li>Click on the trouble-making Habbo&apos;s avatar. A drop-down menu will appear.</li>
...
<ol>
    ...
    <li>Choose <em>Someone is misbehaving</em>. You&apos;ll see a list of all Habbos in the room.</li>
    <li>Click the badly-behaving Habbo.</li>
...
<ol>
    <li>Click the <em>Report</em> button below the other Habbo&apos;s picture in the chat window.</li>
    <li>You will be asked for more information about what happened.</li>
    <li>A Moderator will then take appropriate action.</li>
</ol>
<p><img src="https://habboo-a.akamaihd.net/c_images/Help/report_im.png" alt="Reporting a Habbo in personal messaging">
</p>
...
<h2>Habbo Way</h2>
<p>Haven&apos;t read <a href="/playing-habbo/habbo-way">The Habbo Way</a> yet? Please do! This stuff is really
    important. It&apos;s <strong>a set of simple rules</strong> to follow so that the hotel remains a fun place to hang
    out.</p>
<h2>How to play</h2>
<p>Looking for <strong>ideas on what to do in Habbo</strong>? Read our <a href="/playing-habbo/how-to-play">guide on how
    to play</a>!</p>
<p>If you need <strong>instructions on how to use furni, effects, or any other tool</strong> in the Hotel, click the
    ...
    way.</p>
<h2>Habbo Help Desk</h2>
<p>If you have a <strong>problem with your Habbo account, there was an error with the credits you bought or you have
